...
declare module Jolt {
    ...
    type EShapeType = typeof EShapeType_Convex | typeof EShapeType_Compound | typeof EShapeType_Decorated | typeof EShapeType_Mesh | typeof EShapeType_HeightField;
    ...
    type EShapeSubType = typeof EShapeSubType_Sphere | typeof EShapeSubType_Box | typeof EShapeSubType_Capsule | typeof EShapeSubType_TaperedCapsule | typeof EShapeSubType_Cylinder | typeof EShapeSubType_ConvexHull | typeof EShapeSubType_StaticCompound | typeof EShapeSubType_MutableCompound | typeof EShapeSubType_RotatedTranslated | typeof EShapeSubType_Scaled | typeof EShapeSubType_OffsetCenterOfMass | typeof EShapeSubType_Mesh | typeof EShapeSubType_HeightField;
    ...
    class RRayCast {
        constructor();
        constructor(inOrigin: Vec3, inDirection: Vec3);
        Transformed(inTransform: Mat44): RRayCast;
        Translated(inTranslation: Vec3): RRayCast;
        GetPointOnRay(inFraction: number): Vec3;
        get_mOrigin(): Vec3;
        set_mOrigin(mOrigin: Vec3): void;
        mOrigin: Vec3;
    ...
    class TransformedShape {
        ...
        CollidePoint(inPoint: Vec3, ioCollector: CollidePointCollector, inShapeFilter: ShapeFilter): void;
        CollideShape(inShape: Shape, inShapeScale: Vec3, inCenterOfMassTransform: Mat44, inCollideShapeSettings: CollideShapeSettings, inBaseOffset: Vec3, ioCollector: CollideShapeCollector, inShapeFilter: ShapeFilter): void;
        CastShape(inShapeCast: RShapeCast, inShapeCastSettings: ShapeCastSettings, inBaseOffset: Vec3, ioCollector: CastShapeCollector, inShapeFilter: ShapeFilter): void;
        ...
        GetCenterOfMassTransform(): Mat44;
        GetInverseCenterOfMassTransform(): Mat44;
        SetWorldTransform(inPosition: Vec3, inRotation: Quat, inScale: Vec3): void;
        SetWorldTransform(inTransform: Mat44): void;
        GetWorldTransform(): Mat44;
        GetWorldSpaceBounds(): AABox;
        GetWorldSpaceSurfaceNormal(inSubShapeID: SubShapeID, inPosition: Vec3): Vec3;
        GetMaterial(inSubShapeID: SubShapeID): PhysicsMaterial;
        get_mShapePositionCOM(): Vec3;
        set_mShapePositionCOM(mShapePositionCOM: Vec3): void;
        mShapePositionCOM: Vec3;
    ...
    class Triangle {
        constructor();
        constructor(inV1: Vec3, inV2: Vec3, inV3: Vec3);
    ...
    class IndexedTriangle {
        constructor();
        constructor(inI1: number, inI2: number, inI3: number, inMaterialIndex: number);
    ...
    class SwingTwistConstraintSettings extends TwoBodyConstraintSettings {
        ...
        mSpace: EConstraintSpace;
        get_mPosition1(): Vec3;
        set_mPosition1(mPosition1: Vec3): void;
        mPosition1: Vec3;
        get_mTwistAxis1(): Vec3;
        set_mTwistAxis1(mTwistAxis1: Vec3): void;
        mTwistAxis1: Vec3;
        ...
        mPlaneAxis1: Vec3;
        get_mPosition2(): Vec3;
        set_mPosition2(mPosition2: Vec3): void;
        mPosition2: Vec3;
        get_mTwistAxis2(): Vec3;
        set_mTwistAxis2(mTwistAxis2: Vec3): void;
        mTwistAxis2: Vec3;
    ...
    class GroupFilterJS {
        constructor();
        CanCollide(inGroup1: CollisionGroup, inGroup2: CollisionGroup): boolean;
    }
    ...
    class Body {
        ...
        AddForce(inForce: Vec3, inPosition: Vec3): void;
        ...
        AddImpulse(inImpulse: Vec3, inPosition: Vec3): void;
        AddAngularImpulse(inAngularImpulse: Vec3): void;
        MoveKinematic(inPosition: Vec3, inRotation: Quat, inDeltaTime: number): void;
        ApplyBuoyancyImpulse(inSurfacePosition: Vec3, inSurfaceNormal: Vec3, inBuoyancy: number, inLinearDrag: number, inAngularDrag: number, inFluidVelocity: Vec3, inGravity: Vec3, inDeltaTime: number): boolean;
    ...
    class BodyInterface {
        ...
        SetPositionAndRotation(inBodyID: BodyID, inPosition: Vec3, inRotation: Quat, inActivationMode: EActivation): void;
        SetPositionAndRotationWhenChanged(inBodyID: BodyID, inPosition: Vec3, inRotation: Quat, inActivationMode: EActivation): void;
        GetPositionAndRotation(inBodyID: BodyID, outPosition: Vec3, outRotation: Quat): void;
        SetPosition(inBodyID: BodyID, inPosition: Vec3, inActivationMode: EActivation): void;
        GetPosition(inBodyID: BodyID): Vec3;
        SetRotation(inBodyID: BodyID, inRotation: Quat, inActivationMode: EActivation): void;
        GetRotation(inBodyID: BodyID): Quat;
        MoveKinematic(inBodyID: BodyID, inPosition: Vec3, inRotation: Quat, inDeltaTime: number): void;
        ...
        AddImpulse(inBodyID: BodyID, inImpulse: Vec3, inPosition: Vec3): void;
    ...
    class ContactManifold {
        ...
        GetWorldSpaceContactPointOn1(inIndex: number): Vec3;
        GetWorldSpaceContactPointOn2(inIndex: number): Vec3;
        get_mBaseOffset(): Vec3;
        set_mBaseOffset(mBaseOffset: Vec3): void;
        mBaseOffset: Vec3;
    ...
    class ContactListenerJS {
        constructor();
        OnContactValidate(inBody1: Body, inBody2: Body, inBaseOffset: Vec3, inCollisionResult: CollideShapeResult): number;
    ...
    class RayCastBodyCollectorJS {
        constructor();
        Reset(): void;
        AddHit(inResult: BroadPhaseCastResult): void;
    }
    ...
    class CollideShapeBodyCollectorJS {
        constructor();
        Reset(): void;
        AddHit(inResult: BodyID): void;
    }
    ...
    class CastShapeBodyCollectorJS {
        constructor();
        Reset(): void;
        AddHit(inResult: BroadPhaseCastResult): void;
    }
    ...
    class CastRayCollectorJS {
        constructor();
        Reset(): void;
        OnBody(inBody: Body): void;
        AddHit(inResult: RayCastResult): void;
    }
    ...
    class CollidePointCollectorJS {
        constructor();
        Reset(): void;
        OnBody(inBody: Body): void;
        AddHit(inResult: CollidePointResult): void;
    }
    ...
    class CollideShapeCollectorJS {
        constructor();
        Reset(): void;
        OnBody(inBody: Body): void;
        AddHit(inResult: CollideShapeResult): void;
    }
    ...
    class CastShapeCollectorJS {
        constructor();
        Reset(): void;
        OnBody(inBody: Body): void;
        AddHit(inResult: ShapeCastResult): void;
    }
    ...
    class TransformedShapeCollectorJS {
        constructor();
        Reset(): void;
        OnBody(inBody: Body): void;
        AddHit(inResult: TransformedShape): void;
    }
    class NarrowPhaseQuery {
        ...
        CollidePoint(inPoint: Vec3, ioCollector: CollidePointCollector, inBroadPhaseLayerFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter, inBodyFilter: BodyFilter, inShapeFilter: ShapeFilter): void;
        CollideShape(inShape: Shape, inShapeScale: Vec3, inCenterOfMassTransform: Mat44, inCollideShapeSettings: CollideShapeSettings, inBaseOffset: Vec3, ioCollector: CollideShapeCollector, inBroadPhaseLayerFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter, inBodyFilter: BodyFilter, inShapeFilter: ShapeFilter): void;
        CastShape(inShapeCast: RShapeCast, inShapeCastSettings: ShapeCastSettings, inBaseOffset: Vec3, ioCollector: CastShapeCollector, inBroadPhaseLayerFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter, inBodyFilter: BodyFilter, inShapeFilter: ShapeFilter): void;
    ...
    class PhysicsStepListenerJS {
        constructor();
        OnStep(inDeltaTime: number, inSystem: PhysicsSystem): void;
    }
    class BodyActivationListener {
    }
    class BodyActivationListenerJS {
        constructor();
        OnBodyActivated(inBodyID: BodyID, inBodyUserData: number): void;
        OnBodyDeactivated(inBodyID: BodyID, inBodyUserData: number): void;
    }
    class BodyIDVector {
        constructor();
        empty(): boolean;
    ...
    class PhysicsSystem {
        ...
        SaveState(inStream: StateRecorder, inState?: EStateRecorderState): void;
        RestoreState(inStream: StateRecorder): boolean;
    ...
    class BodyCreationSettings {
        constructor(inShape: Shape, inPosition: Vec3, inRotation: Quat, inMotionType: EMotionType, inObjectLayer: number);
    ...
    class SoftBodyCreationSettings {
        constructor(inSettings: SoftBodySharedSettings, inPosition: Vec3, inRotation: Quat, inObjectLayer: number);
        get_mPosition(): Vec3;
        set_mPosition(mPosition: Vec3): void;
        mPosition: Vec3;
        get_mRotation(): Quat;
    ...
    class CharacterContactListenerJS {
        constructor();
        OnAdjustBodyVelocity(inCharacter: CharacterVirtual, inBody2: Body, ioLinearVelocity: Vec3, ioAngularVelocity: Vec3): void;
        OnContactValidate(inCharacter: CharacterVirtual, inBodyID2: BodyID, inSubShapeID2: SubShapeID): boolean;
        OnContactAdded(inCharacter: CharacterVirtual, inBodyID2: BodyID, inSubShapeID2: SubShapeID, inContactPosition: Vec3, inContactNormal: Vec3, ioSettings: CharacterContactSettings): void;
        OnContactSolve(inCharacter: CharacterVirtual, inBodyID2: BodyID, inSubShapeID2: SubShapeID, inContactPosition: Vec3, inContactNormal: Vec3, inContactVelocity: Vec3, inContactMaterial: PhysicsMaterial, inCharacterVelocity: Vec3, ioNewCharacterVelocity: Vec3): void;
    }
    ...
    class ObjectVsBroadPhaseLayerFilterJS {
        constructor();
        ShouldCollide(inLayer1: number, inLayer2: BroadPhaseLayer): boolean;
    }
    ...
    class BodyFilterJS {
        constructor();
        ShouldCollide(inBodyID: BodyID): boolean;
        ShouldCollideLocked(inBody: Body): boolean;
    }
    ...
    class ShapeFilterJS {
        constructor();
        ShouldCollide(inShape2: Shape, inSubShapeIDOfShape2: SubShapeID): boolean;
    }
    class ShapeFilterJS2 {
        constructor();
        ShouldCollide(inShape1: Shape, inSubShapeIDOfShape1: SubShapeID, inShape2: Shape, inSubShapeIDOfShape2: SubShapeID): boolean;
    }
    class CharacterBase {
        GetRefCount(): number;
        AddRef(): void;
    ...
    class CharacterVirtual extends CharacterBase {
        constructor(inSettings: CharacterVirtualSettings, inPosition: Vec3, inRotation: Quat, inSystem: PhysicsSystem);
        ...
        GetPosition(): Vec3;
        SetPosition(inPosition: Vec3): void;
        GetRotation(): Quat;
    ...
    class VehicleConstraint extends Constraint {
        ...
        GetWheelWorldTransform(inWheelIndex: number, inWheelRight: Vec3, inWheelUp: Vec3): Mat44;
    ...
    class SkeletonPose {
        ...
        SetRootOffset(inOffset: Vec3): void;
        GetRootOffset(): Vec3;
    ...
    class Ragdoll {
        ...
        GetRootTransform(outPosition: Vec3, outRotation: Quat, inLockBodies?: boolean): void;
        GetBodyCount(): number;
    ...
    class BroadPhaseLayerInterfaceJS {
        constructor();
        GetNumBroadPhaseLayers(): number;
