...
namespace InventorAddInFinalButton
{
    /// <summary>
    ...
    /// </summary>
    [GuidAttribute("92b932f0-ff11-4461-801c-9f249981b4af")]
    public class AddInServer : Inventor.ApplicationAddInServer
    {
        ...
        private AddRobotExportButton m_addRobotExportButton;
            ...
            try
            {
               ...
               // Icon addSlotOptionIcon = new Icon(this.GetType(), "AddSlotOption.ico");
                ...
                /*  m_addSlotOptionButton = new AddSlotOptionButton(
                  ...
                  m_addRobotExportButton = new AddRobotExportButton(
                      "Exports dat robot", "Autodesk:SimpleAddIn:ExportRobot", CommandTypesEnum.kShapeEditCmdType,
                      addInCLSIDString, "Exports Robot",
                      "Export Robot", toggleSlotStateIcon, toggleSlotStateIcon, ButtonDisplayEnum.kDisplayTextInLearningMode);*/
                m_addSlotOptionButton = new AddSlotOptionButton(
                "Add Slot width/height", "Autodesk:SimpleAddIn:AddSlotOptionCmdBtn", CommandTypesEnum.kShapeEditCmdType,
                addInCLSIDString, "Adds option for slot width/height",
                "Add slot option", ButtonDisplayEnum.kDisplayTextInLearningMode);

                m_drawSlotButton = new DrawSlotButton(
                    "Draw Slot", "Autodesk:SimpleAddIn:DrawSlotCmdBtn", CommandTypesEnum.kShapeEditCmdType,
                    addInCLSIDString, "Create slot sketch graphics",
                    "Draw Slot", ButtonDisplayEnum.kDisplayTextInLearningMode);

                m_toggleSlotStateButton = new ToggleSlotStateButton(
                    "Toggle Slot State", "Autodesk:SimpleAddIn:ToggleSlotStateCmdBtn", CommandTypesEnum.kShapeEditCmdType,
                    addInCLSIDString, "Enables/Disables state of slot command",
                    "Toggle Slot State", ButtonDisplayEnum.kDisplayTextInLearningMode);


                m_addRobotExportButton = new AddRobotExportButton(
                    "Exports dat robot", "Autodesk:SimpleAddIn:ExportRobot", CommandTypesEnum.kShapeEditCmdType,
                    addInCLSIDString, "Exports Robot",
                    "Export Robot", ButtonDisplayEnum.kDisplayTextInLearningMode);
                ...
                slotCmdCategory.Add(m_addRobotExportButton.ButtonDefinition);
                ...
                if (firstTime == true)
                {
                    ...
                    if (interfaceStyle == InterfaceStyleEnum.kClassicInterface)
                    {
                        ...
                        slotCommandBar.Controls.AddButton(m_addRobotExportButton.ButtonDefinition, 0);
                    ...
                    else
                    {
                        ...
                        CommandControl exportRobot;
                        exportRobot = partSketchSlotRibbonPanelCtrls.AddButton(m_addRobotExportButton.ButtonDefinition, false, true, "", false);
                    }
                }

                MessageBox.Show("To access the commands of the sample addin, activate a 2d sketch of an assembly \n document and select the \"AddInSlot\" toolbar within the panel menu");
                #endregion
        ...
        public void getErrorsGone(int i)
        {
            ...
            try
            {
                ...
                for (int commandBarCt = 1; commandBarCt <= commandBars.Count; commandBarCt++)
                {
                    ...
                    if (commandBar.InternalName == "Autodesk:SimpleAddIn:SlotToolbar")
                    {
                        ...
                        commandBar.Controls.AddButton(m_addRobotExportButton.ButtonDefinition, 0);
