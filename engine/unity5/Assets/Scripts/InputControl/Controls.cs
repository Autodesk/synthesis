...
public class Controls
{
    ...
    public static bool tankDrive = true;
    ...
    static Controls()
    {
        if (GameObject.Find("TankMode") != null)
        {
            TankDrive();
            Load();
            Debug.Log("True");
    ...
    public static void ArcadeDrive()
    {
        ...
        #endregion
        if (GameObject.Find("SettingsMode") != null) GameObject.Find("SettingsMode").GetComponent<SettingsMode>().UpdateAllText();
    }
    ...
    public static void TankDrive()
    {
        ...
        #region Player 2 Controls
        //Tank Controls
        buttons[1].tankFrontLeft = InputControl.setKey("2: Forward", new JoystickInput(JoystickAxis.Axis9Negative, Joystick.Joystick2));
        buttons[1].tankBackLeft = InputControl.setKey("2: Backward", new JoystickInput(JoystickAxis.Axis9Positive, Joystick.Joystick2));
        buttons[1].tankFrontRight = InputControl.setKey("2: Left", new JoystickInput(JoystickAxis.Axis10Negative, Joystick.Joystick2));
        buttons[1].tankBackRight = InputControl.setKey("2: Right", new JoystickInput(JoystickAxis.Axis10Positive, Joystick.Joystick2));
        ...
        #region Player 3 Controls
        //Tank Controls
        buttons[2].tankFrontLeft = InputControl.setKey("3: Forward", new JoystickInput(JoystickAxis.Axis9Negative, Joystick.Joystick3));
        buttons[2].tankBackLeft = InputControl.setKey("3: Backward", new JoystickInput(JoystickAxis.Axis9Positive, Joystick.Joystick3));
        buttons[2].tankFrontRight = InputControl.setKey("3: Left", new JoystickInput(JoystickAxis.Axis10Negative, Joystick.Joystick3));
        buttons[2].tankBackRight = InputControl.setKey("3: Right", new JoystickInput(JoystickAxis.Axis10Positive, Joystick.Joystick3));
        ...
        #region Player 4 Controls
        //Tank Controls
        buttons[3].tankFrontLeft = InputControl.setKey("4: Forward", new JoystickInput(JoystickAxis.Axis9Negative, Joystick.Joystick4));
        buttons[3].tankBackLeft = InputControl.setKey("4: Backward", new JoystickInput(JoystickAxis.Axis9Positive, Joystick.Joystick4));
        buttons[3].tankFrontRight = InputControl.setKey("4: Left", new JoystickInput(JoystickAxis.Axis10Negative, Joystick.Joystick4));
        buttons[3].tankBackRight = InputControl.setKey("4: Right", new JoystickInput(JoystickAxis.Axis10Positive, Joystick.Joystick4));
        ...
        #region Player 5 Controls
        //Tank Controls
        buttons[4].tankFrontLeft = InputControl.setKey("5: Forward", new JoystickInput(JoystickAxis.Axis9Negative, Joystick.Joystick5));
        buttons[4].tankBackLeft = InputControl.setKey("5: Backward", new JoystickInput(JoystickAxis.Axis9Positive, Joystick.Joystick5));
        buttons[4].tankFrontRight = InputControl.setKey("5: Left", new JoystickInput(JoystickAxis.Axis10Negative, Joystick.Joystick5));
        buttons[4].tankBackRight = InputControl.setKey("5: Right", new JoystickInput(JoystickAxis.Axis10Positive, Joystick.Joystick5));
        ...
        #region Player 6 Controls
        //Tank Controls
        buttons[5].tankFrontLeft = InputControl.setKey("6: Forward", new JoystickInput(JoystickAxis.Axis9Negative, Joystick.Joystick6));
        buttons[5].tankBackLeft = InputControl.setKey("6: Backward", new JoystickInput(JoystickAxis.Axis9Positive, Joystick.Joystick6));
        buttons[5].tankFrontRight = InputControl.setKey("6: Left", new JoystickInput(JoystickAxis.Axis10Negative, Joystick.Joystick6));
        buttons[5].tankBackRight = InputControl.setKey("6: Right", new JoystickInput(JoystickAxis.Axis10Positive, Joystick.Joystick6));
