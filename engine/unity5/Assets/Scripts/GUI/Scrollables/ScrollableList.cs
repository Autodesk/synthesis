...
namespace Synthesis.GUI.Scrollables
{
    public class ScrollableList : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            listStyle.hover.background = Resources.Load("Images/OldAssets/darksquaretexture") as Texture2D;
            listStyle.active.background = Resources.Load("images/OldAssets/highlightsquaretexture") as Texture2D;
