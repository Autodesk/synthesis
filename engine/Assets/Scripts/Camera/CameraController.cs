...
public class CameraController : MonoBehaviour {
    ...
    [SerializeField, Range(1f, 15.0f)]
    public static float PitchSensitivity;
    [SerializeField, Range(1f, 15.0f)]
    public static float YawSensitivity;
    ...
    [SerializeField]
    public float ZoomLowerLimit;
    [SerializeField]
    public float ZoomUpperLimit;
    [SerializeField, Range(0.005f, 1.0f)]
    public float OrbitalAcceleration;
    [SerializeField, Range(0.005f, 1.0f)]
