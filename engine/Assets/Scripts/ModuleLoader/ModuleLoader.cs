// TODO: Clang format for this file is off until we either use it or remove it.
// clang-format off
...
//                 // clang-format off
//                 throw new LoadModuleException($"Type of instance variable \"{instance.GetType()}\" does not match declaring type of callback \"{callback.Name}\" (expected \"{callback.DeclaringType}\"");
//                 // clang-format on
//             }
