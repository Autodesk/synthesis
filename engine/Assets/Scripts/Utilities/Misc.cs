...
namespace Engine.Util {
    public static class Misc {
        ...
        public static TGameObject FindUnityObject<TGameObject>(string name)
            where TGameObject : UnityEngine.Object {
            return UnityEngine.Resources.FindObjectsOfTypeAll<TGameObject>().First(o => o.name == name);
        }

        public static UnityEngine.Vector3 MapVector3D(Vector3D vec)           => MathUtil.MapVector3D(vec);
        public static Vector3D MapVector3(UnityEngine.Vector3 vec)            => MathUtil.MapVector3(vec);
        public static Quaternion MapUnityQuaternion(UnityEngine.Quaternion q) => MathUtil.MapUnityQuaternion(q);
        public static UnityEngine.Quaternion MapQuaternion(Quaternion q)      => MathUtil.MapQuaternion(q);
        ...
        public static EventTrigger.Entry MakeEventTriggerEntry(
