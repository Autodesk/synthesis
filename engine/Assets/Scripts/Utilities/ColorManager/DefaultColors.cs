...
namespace Utilities.ColorManager {
    ...
    public static class DefaultColors {
        public static readonly(ColorManager.SynthesisColor name, Color32 color)[] SYNTHESIS_DEFAULT = {
            ...
            (ColorManager.SynthesisColor.InteractiveElementLeft, new Color32(250, 190, 55, 255)),
            (ColorManager.SynthesisColor.InteractiveElementRight, new Color32(230, 90, 15, 255)),
