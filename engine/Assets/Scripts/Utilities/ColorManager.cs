...
namespace Synthesis.UI {
    public static class ColorManager {
        ...
        private static readonly string PATH = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)
            + Path.AltDirectorySeparatorChar + "Autodesk" + Path.AltDirectorySeparatorChar + "Synthesis" + Path.AltDirectorySeparatorChar + "default_colors.json";
        ...
        private static void Save() {
            ...
            _colors.ForEach(x => {
                jsonColors.Add(x.Key, ((Color)x.Value).ToHex());
            });
        ...
        private static void Load() {
            ...
            jsonColors.ForEach(x => {
                _colors.Add(x.Key, x.Value.ColorToHex());
            });
        }
