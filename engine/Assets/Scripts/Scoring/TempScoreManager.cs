...
public class TempScoreManager : MonoBehaviour {
    ...
    public bool RenderScoringZones {
        ...
        set {
            if (_RenderScoringZones != value) {
                ...
                ScoringZones.ForEach(zone => { zone.SetVisibility(value); });
            }
        }
    }
    ...
    public void CreateScoringZones(
        List<GameObject> gameObjects, Alliance alliance, int points, bool destroyObject = true) {
        gameObjects.ForEach(obj => { ScoringZones.Add(new ScoringZone(obj, alliance, points, destroyObject)); });
    }

    public void CreateScoringZonesFromParent(
        GameObject parent, Alliance alliance, int points, bool destroyObject = true) {
