...
public class SocialMediaButtons : MonoBehaviour {
    public void Twitter() {
        Process.Start(
            new ProcessStartInfo() { FileName = "https://twitter.com/synthesis_adsk", UseShellExecute = true });
    }

    public void Youtube() {
        Process.Start(new ProcessStartInfo() { FileName = "https://www.youtube.com/channel/UCqblCh9SOPyLcdMwMiHWR7g",
    ...
    public void Instagram() {
        Process.Start(
            new ProcessStartInfo() { FileName = "https://www.instagram.com/synthesis.adsk/", UseShellExecute = true });
    }
