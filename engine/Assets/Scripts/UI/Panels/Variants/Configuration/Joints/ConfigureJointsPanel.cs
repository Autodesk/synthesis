...
namespace Synthesis.UI.Panels {
    public class ConfigureJointsPanel : Panel {
        ...
        public void PopulateItems() {
            ...
            //     return;
            // SimulationManager.Drivers[RobotSimObject.CurrentlyPossessedRobot].Where(x => x is
            // RotationalDriver).ForEach(y => {
            ...
            //     // Gross
            //     rotItem.Label.text =
            //     RobotSimObject.GetCurrentlyPossessedRobot().MiraLive.MiraAssembly.Data.Signals.SignalMap[rotDriver.InputSignal].Info.Name;
            ...
            //             velo = 0f;
            //         rotDriver.Motor = new JointMotor { targetVelocity = velo, force = rotDriver.Motor.force, freeSpin
            //         = rotDriver.Motor.freeSpin };
            //     });
            ...
            //             torq = 0f;
            //         rotDriver.Motor = new JointMotor { targetVelocity = rotDriver.Motor.targetVelocity, force = torq,
            //         freeSpin = rotDriver.Motor.freeSpin };
            //     });
            // });
        }
    }
