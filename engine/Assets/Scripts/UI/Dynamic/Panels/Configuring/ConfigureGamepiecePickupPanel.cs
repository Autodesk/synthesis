        ...
        public void SetSelectUIState(bool isUserSelecting) {
            if (isUserSelecting) {
                ...
                _selectNodeButton.StepIntoButton(
                    b => b.StepIntoImage(i => i.SetColor(ColorManager.GetColor(ColorManager.SynthesisColor.SynthesisBlackAccent)))
                             .StepIntoLabel(l => l.SetText("...")));
            } else {
                _selectNodeButton.StepIntoLabel(l => l.SetText(_resultingData.NodeName));
                _selectNodeButton.StepIntoButton(b => b.StepIntoImage(i => i.SetColor(ColorManager.GetColor(ColorManager.SynthesisColor.SynthesisOrange)))
