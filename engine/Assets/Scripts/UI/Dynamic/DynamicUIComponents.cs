...
#region Abstracts
    ...
    public abstract class PanelDynamic {
        ...
        protected Content Strip(Vector2? newContentSize = null, float leftPadding = 0f, float rightPadding = 0f, float topPadding = 0f, float bottomPadding = 0f) {
            ...
            if (newContentSize.HasValue) {
                panel.SetSize<Content>(new Vector2(
                        newContentSize.Value.x + leftPadding + rightPadding,
            ...
            var newMainContent = panel.CreateSubContent(
                newContentSize
                ?? new Vector2(panel.Size.x - (rightPadding + leftPadding), panel.Size.y - (topPadding + bottomPadding))
                );
    ...
    public abstract class UIComponent {
        ...
        public T? CheckIfNull<T>() where T : UIComponent {
