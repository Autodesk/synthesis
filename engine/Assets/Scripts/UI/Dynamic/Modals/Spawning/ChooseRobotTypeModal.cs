...
public class ChooseRobotTypeModal : ModalDynamic {
    ...
    public override void Create() {
        ...
        var normal = left.CreateButton("Regular")
            ...
            .AddOnClickedEvent(_ => DynamicUIManager.CreateModal<AddRobotModal>())
            .StepIntoLabel(l => l.SetText("Regular"));

        var Custom = right.CreateButton("Custom")
            .ApplyTemplate(UIComponent.VerticalLayout)
            .AddOnClickedEvent(_ => DynamicUIManager.CreateModal<AddMixAndMatchModal>())
            .StepIntoLabel(l => l.SetText("Custom")).StepIntoImage(i => i.InvertGradient());
    }
