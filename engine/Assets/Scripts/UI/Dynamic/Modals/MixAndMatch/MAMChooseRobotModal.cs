...
namespace UI.Dynamic.Modals.MixAndMatch {
    public class MAMChooseRobotModal : ModalDynamic {
        private const float SPLIT_SPACING = 15;
        private const float CONTENT_WIDTH = 400;
        private const float CONTENT_HEIGHT = 120;

        public MAMChooseRobotModal() : base(new Vector2(CONTENT_WIDTH, CONTENT_HEIGHT)) {}
        ...
        public override void Create() {
            Title.SetText("Select or Create a Robot");
