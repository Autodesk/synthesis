...
public class ConfiguringModal : ModalDynamic {
    public ConfiguringModal() : base(new Vector2(400, 30 + 7.5f + 50 + 7.5f + 30 + 7.5f + 50 + 15/*To space better*/)) { }
    ...
    public override void Create() {
        ...
        var subContent2 = MainContent.CreateSubContent(new Vector2(MainContent.Size.x, 50))
        ...
        // Using scopes because I can't be bothered to rename -Hunter
        {
            ...
            var move = left.CreateButton("Move Robot")
                .SetTopStretch<Button>()
                .AddOnClickedEvent(b => {
                    DynamicUIManager.CloseActiveModal();
