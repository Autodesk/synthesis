...
public class RCConfigPwmGroupModal : ModalDynamic {
    ...
    public override void Create() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            container.SetTopStretch<Content>(leftPadding: 10, rightPadding: 10, anchoredY: -_portSelection.Content.RectOfChildren(container).yMin);
        ...
        _portSelection.Content.SetTopStretch<Content>().SetHeight<Content>(-_portSelection.Content.RectOfChildren().yMin);
        ...
        RobotSimObject.GetCurrentlyPossessedRobot().MiraLive.MiraAssembly.Data.Joints.JointInstances.Values.Where(
            ...
            container.SetTopStretch<Content>(leftPadding: 10, rightPadding: 10, anchoredY: -_signalSelection.Content.RectOfChildren(container).yMin);
        ...
        _signalSelection.Content.SetTopStretch<Content>().SetHeight<Content>(-_signalSelection.Content.RectOfChildren().yMin);
