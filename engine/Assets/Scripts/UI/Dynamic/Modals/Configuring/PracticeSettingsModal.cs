...
public class PracticeSettingsModal : ModalDynamic {
    ...
    public override void Create() {
        ...
        if (field == null) {
            ...
            gamepieceDropdown.SetOptions(primitives).SetValue(0).AddOnValueChangedEvent((d, i, data) => {
            ...
            gamepieceDropdown.SetOptions(_gamepieceSimObjects.Map(g => g.Name).ToArray())
                ...
                .AddOnValueChangedEvent((d, i, data) => { PracticeMode.ChosenGamepiece = _gamepieceMap[data.text]; });
        ...
        (Content bottomLeft, Content bottomRight) =
            bottom.SplitLeftRight((bottom.Size.x - leftRightPadding) / 2f, leftRightPadding);
