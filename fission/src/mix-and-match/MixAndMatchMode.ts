...
import { componentWorldBounds, componentWorldTransform, debugLog, mateFacesTransform, snapToFaceOffset } from "./MixAndMatchPlacement"
...
class MixAndMatchMode {
    ...
    public static async snapToFace(componentId: ComponentId, targetId: ComponentId) {
        ...
        debugLog("[MixAndMatch] snapToFace", {
            componentId,
            targetId,
        ...
        debugLog("[MixAndMatch] snapToFace committed", {
            componentId,
