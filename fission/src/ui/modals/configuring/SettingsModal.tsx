...
const SettingsModal: React.FC<ModalImplProps> = ({ modal, parent }) => {
	...
	return (
		...
		>
			...
			<FormControlLabel
				...
				control={
					<Checkbox
						defaultChecked={PreferencesSystem.getGlobalPreference(
							"ShowViewCube",
						)}
						onChange={(e) => {
							PreferencesSystem.setGlobalPreference(
			...
			<Stack direction="column">
				...
				<StatefulSlider
					...
					// format={{ maximumFractionDigits: 2 }}
					onChange={(value) =>
						PreferencesSystem.setGlobalPreference("SFXVolume", value)
					}
