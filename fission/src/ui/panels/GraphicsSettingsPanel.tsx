...
const GraphicsSettingsPanel: React.FC<PanelImplProps<void, void>> = ({ panel }) => {
    ...
    }, [fancyShadows, lightIntensity, maxFar, cascades, shadowMapSize, antiAliasing, reload, panel, configureScreen])
    ...
    return (
        <Stack gap={2}>
            ...
            <Checkbox label="Anti-Aliasing" checked={antiAliasing} onClick={handleAntiAliasingChange} />
        </Stack>
    )
}
