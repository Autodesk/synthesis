...
function FlowControls({ onCreateJunction }: FlowControlsProps) {
    ...
    return (
        ...
        >
            <FlowControlButton onClick={fitView}><MdFitScreen className="w-full h-full" /></FlowControlButton>
            <FlowControlButton onClick={zoomOut}><MdZoomOutMap className="w-full h-full" /></FlowControlButton>
            <FlowControlButton onClick={zoomIn}><MdZoomInMap className="w-full h-full" /></FlowControlButton>
            <FlowControlButton onClick={onCreateJunction}><FaPlus className="w-full h-full" /></FlowControlButton>
        </FlowPanel>
    )
}
