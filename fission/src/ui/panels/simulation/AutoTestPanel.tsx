...
function _end({ assembly, setStaging, captures }: EndProps) {
    useEffect(() => {
...
function _playing({ assembly, setEnd, countdown, captures }: PlayingProps) {
...
function _staging({ assembly, setPlaying }: StagingProps) {
