...
class InputSystem extends WorldSystem {
    ...
    public static get globalInputs(): { [key: string]: Input } {
        return Object.fromEntries(Object.entries(InputSystem.allInputs).filter(([_, input]) => input.isGlobal))
    }
    ...
    public Update(_: number): void {
        ...
        InputSystem._currentModifierState = {
    ...
    public static getInput(inputName: string): boolean {
        ...
        if (inputName in this.allInputs) {
            ...
            if (!this.CompareModifiers(InputSystem._currentModifierState, targetInput.modifiers)) return false
