...
import { joltQuatThreeQuaternion, joltVec3ThreeVector3 } from "@/util/TypeConversions"
...
export class SimAccelInput extends SimInput {
    ...
    public update(deltaT: number) {
        ...
        const rot = joltQuatThreeQuaternion(body.GetRotation())
        const mat = new THREE.Matrix4().makeRotationFromQuaternion(rot).transpose()
        const newVel = joltVec3ThreeVector3(body.GetLinearVelocity()).applyMatrix4(mat)
