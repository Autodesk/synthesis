...
describe("MirabufLoader", () => {
    ...
    describe("Real Fetch", { timeout: 20000 }, () => {
        ...
        const tests: [string, MiraType][] = [
            ...
            ["/api/mira/fields/FRC Field 2023 v10.mira", MiraType.FIELD],
        ]
        ...
        test("Remove All Cleans Up", async () => {
            const field1 = await MirabufLoader.cacheRemote("/api/mira/fields/FRC Field 2023 v10.mira", MiraType.FIELD)
