...
const int32_t CANTalon::kControllerRate = 1000;
const double CANTalon::kApproxBusVoltage = 12.0;

/**
 * Common initialization code called by all constructors.
 */
void CANTalon::InitCANTalon()
{
	m_table = NULL;
	...
	nUsageReporting::report(nUsageReporting::kResourceType_CANTalon, m_deviceNumber, m_controlMode);
	LiveWindow::GetInstance()->AddActuator("CANTalon", m_deviceNumber, 0, this);
}
 ...
 */
CANTalon::CANTalon(uint8_t deviceNumber, ControlMode controlMode)
 ...
 */
void CANTalon::Set(float outputValue, uint8_t syncGroup)
{
	uint32_t messageID;
...
uint8_t CANTalon::packPercentage(uint8_t *buffer, double value)
{
...
uint8_t CANTalon::packFXP8_8(uint8_t *buffer, double value)
{
...
uint8_t CANTalon::packFXP16_16(uint8_t *buffer, double value)
{
...
uint8_t CANTalon::packint16_t(uint8_t *buffer, int16_t value)
{
	*((int16_t*)buffer) = swap16(value);
	return sizeof(int16_t);
}

uint8_t CANTalon::packint32_t(uint8_t *buffer, int32_t value)
{
	*((int32_t*)buffer) = swap32(value);
	return sizeof(int32_t);
}

double CANTalon::unpackPercentage(uint8_t *buffer)
{
...
double CANTalon::unpackFXP8_8(uint8_t *buffer)
{
	int16_t value = *((int16_t*)buffer);
	value = swap16(value);
	return value / 256.0;
...
double CANTalon::unpackFXP16_16(uint8_t *buffer)
{
...
int16_t CANTalon::unpackint16_t(uint8_t *buffer)
{
	int16_t value = *((int16_t*)buffer);
	return swap16(value);
}

int32_t CANTalon::unpackint32_t(uint8_t *buffer)
{
	int32_t value = *((int32_t*)buffer);
	return swap32(value);
}
 ...
 */
int32_t CANTalon::sendMessage(uint32_t messageID, const uint8_t *data, uint8_t dataSize)
{
 ...
 */
int32_t CANTalon::receiveMessage(uint32_t *messageID, uint8_t *data, uint8_t *dataSize, float timeout)
{
	int32_t status = 0;
 ...
 * @param dataSize Specify how much of the data in "data" to send
 */
void CANTalon::setTransaction(uint32_t messageID, const uint8_t *data, uint8_t dataSize)
{
 ...
 * @param dataSize Indicates how much data was received
 */
void CANTalon::getTransaction(uint32_t messageID, uint8_t *data, uint8_t *dataSize)
{
 ...
 */
void CANTalon::SetSpeedReference(SpeedReference reference)
{
	uint8_t dataBuffer[8];
 ...
 */
CANTalon::SpeedReference CANTalon::GetSpeedReference()
{
	uint8_t dataBuffer[8];
	uint8_t dataSize;
 ...
 */
void CANTalon::SetPositionReference(PositionReference reference)
{
	uint8_t dataBuffer[8];
 ...
 */
CANTalon::PositionReference CANTalon::GetPositionReference()
{
	uint8_t dataBuffer[8];
	uint8_t dataSize;
 ...
 */
void CANTalon::EnableControl(double encoderInitialPosition)
{
	uint8_t dataBuffer[8];
	uint8_t dataSize = 0;
 ...
 */
void CANTalon::ChangeControlMode(ControlMode controlMode)
{
 ...
 */
CANTalon::ControlMode CANTalon::GetControlMode()
{
	uint8_t dataBuffer[8];
	uint8_t dataSize;
 ...
 */
uint8_t CANTalon::GetHardwareVersion()
{
	uint8_t dataBuffer[8];
	uint8_t dataSize;
 ...
 */
void CANTalon::UpdateSyncGroup(uint8_t syncGroup)
{
