...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_urlrequest_client_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_upload_progress_delegate(
            cef_urlrequest_client_t *self, cef_urlrequest_t *request, long current, long total);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_download_progress_delegate(
            cef_urlrequest_client_t *self, cef_urlrequest_t *request, long current, long total);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_download_data_delegate(
            cef_urlrequest_client_t *self, cef_urlrequest_t *request, void *data, UIntPtr data_length);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int get_auth_credentials_delegate(cef_urlrequest_client_t *self, int isProxy,
            cef_string_t *host, int port, cef_string_t *realm, cef_string_t *scheme, cef_auth_callback_t *callback);
