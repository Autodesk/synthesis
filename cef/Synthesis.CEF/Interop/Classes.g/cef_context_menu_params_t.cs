...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_context_menu_params_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate int get_dictionary_suggestions_delegate(
            cef_context_menu_params_t *self, cef_string_list *suggestions);
        ...
        public static cef_string_userfree *get_unfiltered_link_url(cef_context_menu_params_t *self) {
            ...
            if (p == _p8) {
                ...
                d = (get_unfiltered_link_url_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_unfiltered_link_url_delegate));
                if (_p8 == IntPtr.Zero) {
                    _d8 = d;
                    _p8 = p;
                }
        ...
        public static int has_image_contents(cef_context_menu_params_t *self) {
            ...
            if (p == _pa) {
                ...
                d = (has_image_contents_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(has_image_contents_delegate));
                if (_pa == IntPtr.Zero) {
                    _da = d;
                    _pa = p;
                }
        ...
        public static cef_string_userfree *get_frame_charset(cef_context_menu_params_t *self) {
            ...
            if (p == _pe) {
                ...
                d = (get_frame_charset_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_frame_charset_delegate));
                if (_pe == IntPtr.Zero) {
                    _de = d;
                    _pe = p;
                }
        ...
        public static CefContextMenuMediaStateFlags get_media_state_flags(cef_context_menu_params_t *self) {
            ...
            if (p == _p10) {
                ...
                d = (get_media_state_flags_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_media_state_flags_delegate));
                if (_p10 == IntPtr.Zero) {
                    _d10 = d;
                    _p10 = p;
                }
        ...
        public static cef_string_userfree *get_selection_text(cef_context_menu_params_t *self) {
            ...
            if (p == _p11) {
                ...
                d = (get_selection_text_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_selection_text_delegate));
                if (_p11 == IntPtr.Zero) {
                    _d11 = d;
                    _p11 = p;
                }
        ...
        public static cef_string_userfree *get_misspelled_word(cef_context_menu_params_t *self) {
            ...
            if (p == _p12) {
                ...
                d = (get_misspelled_word_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_misspelled_word_delegate));
                if (_p12 == IntPtr.Zero) {
                    _d12 = d;
                    _p12 = p;
                }
        ...
        public static int get_dictionary_suggestions(cef_context_menu_params_t *self, cef_string_list *suggestions) {
            ...
            if (p == _p13) {
                ...
                d = (get_dictionary_suggestions_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_dictionary_suggestions_delegate));
                if (_p13 == IntPtr.Zero) {
                    _d13 = d;
                    _p13 = p;
                }
        ...
        public static int is_spell_check_enabled(cef_context_menu_params_t *self) {
            ...
            if (p == _p15) {
                ...
                d = (is_spell_check_enabled_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(is_spell_check_enabled_delegate));
                if (_p15 == IntPtr.Zero) {
                    _d15 = d;
                    _p15 = p;
                }
        ...
        public static CefContextMenuEditStateFlags get_edit_state_flags(cef_context_menu_params_t *self) {
            ...
            if (p == _p16) {
                ...
                d = (get_edit_state_flags_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_edit_state_flags_delegate));
                if (_p16 == IntPtr.Zero) {
                    _d16 = d;
                    _p16 = p;
                }
