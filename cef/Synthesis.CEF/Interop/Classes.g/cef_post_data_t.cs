...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_post_data_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void get_elements_delegate(
            cef_post_data_t *self, UIntPtr *elementsCount, cef_post_data_element_t **elements);
        ...
        public static int has_excluded_elements(cef_post_data_t *self) {
            ...
            if (p == _p5) {
                ...
                d = (has_excluded_elements_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(has_excluded_elements_delegate));
                if (_p5 == IntPtr.Zero) {
                    _d5 = d;
                    _p5 = p;
                }
        ...
        public static UIntPtr get_element_count(cef_post_data_t *self) {
            ...
            if (p == _p6) {
                ...
                d = (get_element_count_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_element_count_delegate));
                if (_p6 == IntPtr.Zero) {
                    _d6 = d;
                    _p6 = p;
                }
        ...
        public static void get_elements(
            cef_post_data_t *self, UIntPtr *elementsCount, cef_post_data_element_t **elements) {
        ...
        public static void remove_elements(cef_post_data_t *self) {
            ...
            if (p == _pa) {
                ...
                d = (remove_elements_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(remove_elements_delegate));
                if (_pa == IntPtr.Zero) {
                    _da = d;
                    _pa = p;
                }
