...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_resource_bundle_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate cef_binary_value_t *get_data_resource_for_scale_delegate(
            cef_resource_bundle_t *self, int resource_id, CefScaleFactor scale_factor);
        ...
        public static cef_string_userfree *get_localized_string(cef_resource_bundle_t *self, int string_id) {
            ...
            if (p == _p4) {
                ...
                d = (get_localized_string_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_localized_string_delegate));
                if (_p4 == IntPtr.Zero) {
                    _d4 = d;
                    _p4 = p;
                }
        ...
        public static cef_binary_value_t *get_data_resource(cef_resource_bundle_t *self, int resource_id) {
            ...
            if (p == _p5) {
                ...
                d = (get_data_resource_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_data_resource_delegate));
                if (_p5 == IntPtr.Zero) {
                    _d5 = d;
                    _p5 = p;
                }
        ...
        public static cef_binary_value_t *get_data_resource_for_scale(
            cef_resource_bundle_t *self, int resource_id, CefScaleFactor scale_factor) {
            ...
            if (p == _p6) {
                ...
                d = (get_data_resource_for_scale_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_data_resource_for_scale_delegate));
                if (_p6 == IntPtr.Zero) {
                    _d6 = d;
                    _p6 = p;
                }
