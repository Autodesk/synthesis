...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_x509certificate_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void get_derencoded_issuer_chain_delegate(
            cef_x509certificate_t *self, UIntPtr *chainCount, cef_binary_value_t **chain);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void get_pemencoded_issuer_chain_delegate(
            cef_x509certificate_t *self, UIntPtr *chainCount, cef_binary_value_t **chain);
        ...
        public static cef_binary_value_t *get_serial_number(cef_x509certificate_t *self) {
            ...
            if (p == _p6) {
                ...
                d = (get_serial_number_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_serial_number_delegate));
                if (_p6 == IntPtr.Zero) {
                    _d6 = d;
                    _p6 = p;
                }
        ...
        public static CefBaseTime get_valid_start(cef_x509certificate_t *self) {
            ...
            if (p == _p7) {
                ...
                d = (get_valid_start_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_valid_start_delegate));
                if (_p7 == IntPtr.Zero) {
                    _d7 = d;
                    _p7 = p;
                }
        ...
        public static CefBaseTime get_valid_expiry(cef_x509certificate_t *self) {
            ...
            if (p == _p8) {
                ...
                d = (get_valid_expiry_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_valid_expiry_delegate));
                if (_p8 == IntPtr.Zero) {
                    _d8 = d;
                    _p8 = p;
                }
        ...
        public static UIntPtr get_issuer_chain_size(cef_x509certificate_t *self) {
            ...
            if (p == _pb) {
                ...
                d = (get_issuer_chain_size_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_issuer_chain_size_delegate));
                if (_pb == IntPtr.Zero) {
                    _db = d;
                    _pb = p;
                }
        ...
        public static void get_derencoded_issuer_chain(
            cef_x509certificate_t *self, UIntPtr *chainCount, cef_binary_value_t **chain) {
            ...
            if (p == _pc) {
                ...
                d = (get_derencoded_issuer_chain_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_derencoded_issuer_chain_delegate));
                if (_pc == IntPtr.Zero) {
                    _dc = d;
                    _pc = p;
                }
        ...
        public static void get_pemencoded_issuer_chain(
            cef_x509certificate_t *self, UIntPtr *chainCount, cef_binary_value_t **chain) {
            ...
            if (p == _pd) {
                ...
                d = (get_pemencoded_issuer_chain_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_pemencoded_issuer_chain_delegate));
                if (_pd == IntPtr.Zero) {
                    _dd = d;
                    _pd = p;
                }
