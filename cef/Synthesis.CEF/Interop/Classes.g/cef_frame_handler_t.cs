...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_frame_handler_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_frame_created_delegate(
            cef_frame_handler_t *self, cef_browser_t *browser, cef_frame_t *frame);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_frame_attached_delegate(
            cef_frame_handler_t *self, cef_browser_t *browser, cef_frame_t *frame, int reattached);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_frame_detached_delegate(
            cef_frame_handler_t *self, cef_browser_t *browser, cef_frame_t *frame);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_main_frame_changed_delegate(
            cef_frame_handler_t *self, cef_browser_t *browser, cef_frame_t *old_frame, cef_frame_t *new_frame);
