...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_request_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void set_referrer_delegate(
            cef_request_t *self, cef_string_t *referrer_url, CefReferrerPolicy policy);
        ...
        private delegate void set_header_by_name_delegate(
            cef_request_t *self, cef_string_t *name, cef_string_t *value, int overwrite);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void set_delegate(cef_request_t *self, cef_string_t *url, cef_string_t *method,
            cef_post_data_t *postData, cef_string_multimap *headerMap);
        ...
        public static cef_string_userfree *get_referrer_url(cef_request_t *self) {
            ...
            if (p == _pa) {
                ...
                d = (get_referrer_url_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_referrer_url_delegate));
                if (_pa == IntPtr.Zero) {
                    _da = d;
                    _pa = p;
                }
        ...
        public static CefReferrerPolicy get_referrer_policy(cef_request_t *self) {
            ...
            if (p == _pb) {
                ...
                d = (get_referrer_policy_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_referrer_policy_delegate));
                if (_pb == IntPtr.Zero) {
                    _db = d;
                    _pb = p;
                }
        ...
        public static void set(cef_request_t *self, cef_string_t *url, cef_string_t *method, cef_post_data_t *postData,
            cef_string_multimap *headerMap) {
            set_delegate d;
            var p = self->_set;
            if (p == _p12) {
                d = _d12;
        ...
        public static cef_string_userfree *get_first_party_for_cookies(cef_request_t *self) {
            ...
            if (p == _p15) {
                ...
                d = (get_first_party_for_cookies_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_first_party_for_cookies_delegate));
                if (_p15 == IntPtr.Zero) {
                    _d15 = d;
                    _p15 = p;
                }
        ...
        public static void set_first_party_for_cookies(cef_request_t *self, cef_string_t *url) {
            ...
            if (p == _p16) {
                ...
                d = (set_first_party_for_cookies_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(set_first_party_for_cookies_delegate));
                if (_p16 == IntPtr.Zero) {
                    _d16 = d;
                    _p16 = p;
                }
        ...
        public static CefResourceType get_resource_type(cef_request_t *self) {
            ...
            if (p == _p17) {
                ...
                d = (get_resource_type_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_resource_type_delegate));
                if (_p17 == IntPtr.Zero) {
                    _d17 = d;
                    _p17 = p;
                }
        ...
        public static CefTransitionType get_transition_type(cef_request_t *self) {
            ...
            if (p == _p18) {
                ...
                d = (get_transition_type_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_transition_type_delegate));
                if (_p18 == IntPtr.Zero) {
                    _d18 = d;
                    _p18 = p;
                }
