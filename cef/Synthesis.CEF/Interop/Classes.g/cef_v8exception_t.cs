    ...
    internal unsafe struct cef_v8exception_t {
        ...
        public static cef_string_userfree *get_source_line(cef_v8exception_t *self) {
            ...
            if (p == _p5) {
                ...
                d = (get_source_line_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_source_line_delegate));
                if (_p5 == IntPtr.Zero) {
                    _d5 = d;
                    _p5 = p;
                }
        ...
        public static cef_string_userfree *get_script_resource_name(cef_v8exception_t *self) {
            ...
            if (p == _p6) {
                ...
                d = (get_script_resource_name_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_script_resource_name_delegate));
                if (_p6 == IntPtr.Zero) {
                    _d6 = d;
                    _p6 = p;
                }
        ...
        public static int get_start_position(cef_v8exception_t *self) {
            ...
            if (p == _p8) {
                ...
                d = (get_start_position_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_start_position_delegate));
                if (_p8 == IntPtr.Zero) {
                    _d8 = d;
                    _p8 = p;
                }
        ...
        public static int get_end_position(cef_v8exception_t *self) {
            ...
            if (p == _p9) {
                ...
                d = (get_end_position_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_end_position_delegate));
                if (_p9 == IntPtr.Zero) {
                    _d9 = d;
                    _p9 = p;
                }
        ...
        public static int get_start_column(cef_v8exception_t *self) {
            ...
            if (p == _pa) {
                ...
                d = (get_start_column_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_start_column_delegate));
                if (_pa == IntPtr.Zero) {
                    _da = d;
                    _pa = p;
                }
