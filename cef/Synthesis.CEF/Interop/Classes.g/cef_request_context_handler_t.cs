...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_request_context_handler_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_request_context_initialized_delegate(
            cef_request_context_handler_t *self, cef_request_context_t *request_context);
        ...
        internal delegate cef_resource_request_handler_t *get_resource_request_handler_delegate(
            cef_request_context_handler_t *self, cef_browser_t *browser, cef_frame_t *frame, cef_request_t *request,
