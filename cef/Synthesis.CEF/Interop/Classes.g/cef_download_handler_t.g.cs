...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_download_handler_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int can_download_delegate(
            cef_download_handler_t *self, cef_browser_t *browser, cef_string_t *url, cef_string_t *request_method);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_before_download_delegate(cef_download_handler_t *self, cef_browser_t *browser,
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_download_updated_delegate(cef_download_handler_t *self, cef_browser_t *browser,
            cef_download_item_t *download_item, cef_download_item_callback_t *callback);
