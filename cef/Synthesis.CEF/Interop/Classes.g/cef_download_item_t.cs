    ...
    internal unsafe struct cef_download_item_t {
        ...
        public static long get_current_speed(cef_download_item_t *self) {
            ...
            if (p == _p8) {
                ...
                d = (get_current_speed_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_current_speed_delegate));
                if (_p8 == IntPtr.Zero) {
                    _d8 = d;
                    _p8 = p;
                }
        ...
        public static int get_percent_complete(cef_download_item_t *self) {
            ...
            if (p == _p9) {
                ...
                d = (get_percent_complete_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_percent_complete_delegate));
                if (_p9 == IntPtr.Zero) {
                    _d9 = d;
                    _p9 = p;
                }
        ...
        public static long get_total_bytes(cef_download_item_t *self) {
            ...
            if (p == _pa) {
                ...
                d = (get_total_bytes_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_total_bytes_delegate));
                if (_pa == IntPtr.Zero) {
                    _da = d;
                    _pa = p;
                }
        ...
        public static long get_received_bytes(cef_download_item_t *self) {
            ...
            if (p == _pb) {
                ...
                d = (get_received_bytes_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_received_bytes_delegate));
                if (_pb == IntPtr.Zero) {
                    _db = d;
                    _pb = p;
                }
        ...
        public static cef_string_userfree *get_original_url(cef_download_item_t *self) {
            ...
            if (p == _p11) {
                ...
                d = (get_original_url_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_original_url_delegate));
                if (_p11 == IntPtr.Zero) {
                    _d11 = d;
                    _p11 = p;
                }
        ...
        public static cef_string_userfree *get_suggested_file_name(cef_download_item_t *self) {
            ...
            if (p == _p12) {
                ...
                d = (get_suggested_file_name_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_suggested_file_name_delegate));
                if (_p12 == IntPtr.Zero) {
                    _d12 = d;
                    _p12 = p;
                }
        ...
        public static cef_string_userfree *get_content_disposition(cef_download_item_t *self) {
            ...
            if (p == _p13) {
                ...
                d = (get_content_disposition_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_content_disposition_delegate));
                if (_p13 == IntPtr.Zero) {
                    _d13 = d;
                    _p13 = p;
                }
