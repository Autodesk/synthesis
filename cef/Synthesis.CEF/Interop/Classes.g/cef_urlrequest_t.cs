...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_urlrequest_t {
        ...
        public static extern cef_urlrequest_t *create(
            cef_request_t *request, cef_urlrequest_client_t *client, cef_request_context_t *request_context);
        ...
        public static CefUrlRequestStatus get_request_status(cef_urlrequest_t *self) {
            ...
            if (p == _p6) {
                ...
                d = (get_request_status_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_request_status_delegate));
                if (_p6 == IntPtr.Zero) {
                    _d6 = d;
                    _p6 = p;
                }
        ...
        public static CefErrorCode get_request_error(cef_urlrequest_t *self) {
            ...
            if (p == _p7) {
                ...
                d = (get_request_error_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_request_error_delegate));
                if (_p7 == IntPtr.Zero) {
                    _d7 = d;
                    _p7 = p;
                }
        ...
        public static int response_was_cached(cef_urlrequest_t *self) {
            ...
            if (p == _p9) {
                ...
                d = (response_was_cached_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(response_was_cached_delegate));
                if (_p9 == IntPtr.Zero) {
                    _d9 = d;
                    _p9 = p;
                }
