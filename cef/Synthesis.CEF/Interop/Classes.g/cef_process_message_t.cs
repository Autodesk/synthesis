    ...
    internal unsafe struct cef_process_message_t {
        ...
        public static cef_list_value_t *get_argument_list(cef_process_message_t *self) {
            ...
            if (p == _p8) {
                ...
                d = (get_argument_list_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_argument_list_delegate));
                if (_p8 == IntPtr.Zero) {
                    _d8 = d;
                    _p8 = p;
                }
        ...
        public static cef_shared_memory_region_t *get_shared_memory_region(cef_process_message_t *self) {
            ...
            if (p == _p9) {
                ...
                d = (get_shared_memory_region_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_shared_memory_region_delegate));
                if (_p9 == IntPtr.Zero) {
                    _d9 = d;
                    _p9 = p;
                }
