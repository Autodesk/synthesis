...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_context_menu_handler_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_before_context_menu_delegate(cef_context_menu_handler_t *self, cef_browser_t *browser,
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int run_context_menu_delegate(cef_context_menu_handler_t *self, cef_browser_t *browser,
            cef_frame_t *frame, cef_context_menu_params_t *@params, cef_menu_model_t *model,
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int on_context_menu_command_delegate(cef_context_menu_handler_t *self, cef_browser_t *browser,
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_context_menu_dismissed_delegate(
            cef_context_menu_handler_t *self, cef_browser_t *browser, cef_frame_t *frame);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int run_quick_menu_delegate(cef_context_menu_handler_t *self, cef_browser_t *browser,
            cef_frame_t *frame, cef_point_t *location, cef_size_t *size, CefQuickMenuEditStateFlags edit_state_flags,
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int on_quick_menu_command_delegate(cef_context_menu_handler_t *self, cef_browser_t *browser,
            cef_frame_t *frame, int command_id, CefEventFlags event_flags);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_quick_menu_dismissed_delegate(
            cef_context_menu_handler_t *self, cef_browser_t *browser, cef_frame_t *frame);
