...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_cookie_manager_t {
        ...
        // GetGlobalManager
        [DllImport(
            libcef.DllName, EntryPoint = "cef_cookie_manager_get_global_manager", CallingConvention = libcef.CEF_CALL)]
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate int visit_url_cookies_delegate(
            cef_cookie_manager_t *self, cef_string_t *url, int includeHttpOnly, cef_cookie_visitor_t *visitor);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate int set_cookie_delegate(
            cef_cookie_manager_t *self, cef_string_t *url, cef_cookie_t *cookie, cef_set_cookie_callback_t *callback);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate int delete_cookies_delegate(cef_cookie_manager_t *self, cef_string_t *url,
            cef_string_t *cookie_name, cef_delete_cookies_callback_t *callback);
        ...
        public static int visit_all_cookies(cef_cookie_manager_t *self, cef_cookie_visitor_t *visitor) {
            ...
            if (p == _p4) {
                ...
                d = (visit_all_cookies_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(visit_all_cookies_delegate));
                if (_p4 == IntPtr.Zero) {
                    _d4 = d;
                    _p4 = p;
                }
        ...
        public static int visit_url_cookies(
            cef_cookie_manager_t *self, cef_string_t *url, int includeHttpOnly, cef_cookie_visitor_t *visitor) {
            ...
            if (p == _p5) {
                ...
                d = (visit_url_cookies_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(visit_url_cookies_delegate));
                if (_p5 == IntPtr.Zero) {
                    _d5 = d;
                    _p5 = p;
                }
