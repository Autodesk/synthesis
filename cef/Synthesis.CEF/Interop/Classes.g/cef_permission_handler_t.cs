...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_permission_handler_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int on_request_media_access_permission_delegate(cef_permission_handler_t *self,
            cef_browser_t *browser, cef_frame_t *frame, cef_string_t *requesting_origin, uint requested_permissions,
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int on_show_permission_prompt_delegate(cef_permission_handler_t *self, cef_browser_t *browser,
            ulong prompt_id, cef_string_t *requesting_origin, uint requested_permissions,
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_dismiss_permission_prompt_delegate(
            cef_permission_handler_t *self, cef_browser_t *browser, ulong prompt_id, CefPermissionRequestResult result);
