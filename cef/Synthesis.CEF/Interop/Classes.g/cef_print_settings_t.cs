...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_print_settings_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void set_printer_printable_area_delegate(cef_print_settings_t *self,
            cef_size_t *physical_size_device_units, cef_rect_t *printable_area_device_units, int landscape_needs_flip);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void set_page_ranges_delegate(
            cef_print_settings_t *self, UIntPtr rangesCount, cef_range_t *ranges);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void get_page_ranges_delegate(
            cef_print_settings_t *self, UIntPtr *rangesCount, cef_range_t *ranges);
        ...
        public static void set_orientation(cef_print_settings_t *self, int landscape) {
            ...
            if (p == _p6) {
                ...
                d = (set_orientation_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(set_orientation_delegate));
                if (_p6 == IntPtr.Zero) {
                    _d6 = d;
                    _p6 = p;
                }
        ...
        public static void set_printer_printable_area(cef_print_settings_t *self,
            cef_size_t *physical_size_device_units, cef_rect_t *printable_area_device_units, int landscape_needs_flip) {
            ...
            if (p == _p8) {
                ...
                d = (set_printer_printable_area_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(set_printer_printable_area_delegate));
                if (_p8 == IntPtr.Zero) {
                    _d8 = d;
                    _p8 = p;
                }
        ...
        public static void set_device_name(cef_print_settings_t *self, cef_string_t *name) {
            ...
            if (p == _p9) {
                ...
                d = (set_device_name_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(set_device_name_delegate));
                if (_p9 == IntPtr.Zero) {
                    _d9 = d;
                    _p9 = p;
                }
        ...
        public static cef_string_userfree *get_device_name(cef_print_settings_t *self) {
            ...
            if (p == _pa) {
                ...
                d = (get_device_name_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_device_name_delegate));
                if (_pa == IntPtr.Zero) {
                    _da = d;
                    _pa = p;
                }
        ...
        public static void set_page_ranges(cef_print_settings_t *self, UIntPtr rangesCount, cef_range_t *ranges) {
            ...
            if (p == _pd) {
                ...
                d = (set_page_ranges_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(set_page_ranges_delegate));
                if (_pd == IntPtr.Zero) {
                    _dd = d;
                    _pd = p;
                }
        ...
        public static UIntPtr get_page_ranges_count(cef_print_settings_t *self) {
            ...
            if (p == _pe) {
                ...
                d = (get_page_ranges_count_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_page_ranges_count_delegate));
                if (_pe == IntPtr.Zero) {
                    _de = d;
                    _pe = p;
                }
        ...
        public static void get_page_ranges(cef_print_settings_t *self, UIntPtr *rangesCount, cef_range_t *ranges) {
            ...
            if (p == _pf) {
                ...
                d = (get_page_ranges_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_page_ranges_delegate));
                if (_pf == IntPtr.Zero) {
                    _df = d;
                    _pf = p;
                }
        ...
        public static void set_selection_only(cef_print_settings_t *self, int selection_only) {
            ...
            if (p == _p10) {
                ...
                d = (set_selection_only_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(set_selection_only_delegate));
                if (_p10 == IntPtr.Zero) {
                    _d10 = d;
                    _p10 = p;
                }
        ...
        public static int is_selection_only(cef_print_settings_t *self) {
            ...
            if (p == _p11) {
                ...
                d = (is_selection_only_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(is_selection_only_delegate));
                if (_p11 == IntPtr.Zero) {
                    _d11 = d;
                    _p11 = p;
                }
        ...
        public static void set_color_model(cef_print_settings_t *self, CefColorModel model) {
            ...
            if (p == _p14) {
                ...
                d = (set_color_model_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(set_color_model_delegate));
                if (_p14 == IntPtr.Zero) {
                    _d14 = d;
                    _p14 = p;
                }
        ...
        public static CefColorModel get_color_model(cef_print_settings_t *self) {
            ...
            if (p == _p15) {
                ...
                d = (get_color_model_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_color_model_delegate));
                if (_p15 == IntPtr.Zero) {
                    _d15 = d;
                    _p15 = p;
                }
        ...
        public static void set_duplex_mode(cef_print_settings_t *self, CefDuplexMode mode) {
            ...
            if (p == _p18) {
                ...
                d = (set_duplex_mode_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(set_duplex_mode_delegate));
                if (_p18 == IntPtr.Zero) {
                    _d18 = d;
                    _p18 = p;
                }
        ...
        public static CefDuplexMode get_duplex_mode(cef_print_settings_t *self) {
            ...
            if (p == _p19) {
                ...
                d = (get_duplex_mode_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_duplex_mode_delegate));
                if (_p19 == IntPtr.Zero) {
                    _d19 = d;
                    _p19 = p;
                }
