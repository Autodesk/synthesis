    ...
    internal unsafe struct cef_sslstatus_t {
        ...
        public static int is_secure_connection(cef_sslstatus_t *self) {
            ...
            if (p == _p4) {
                ...
                d = (is_secure_connection_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(is_secure_connection_delegate));
                if (_p4 == IntPtr.Zero) {
                    _d4 = d;
                    _p4 = p;
                }
        ...
        public static CefCertStatus get_cert_status(cef_sslstatus_t *self) {
            ...
            if (p == _p5) {
                ...
                d = (get_cert_status_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_cert_status_delegate));
                if (_p5 == IntPtr.Zero) {
                    _d5 = d;
                    _p5 = p;
                }
        ...
        public static CefSslContentStatus get_content_status(cef_sslstatus_t *self) {
            ...
            if (p == _p7) {
                ...
                d = (get_content_status_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_content_status_delegate));
                if (_p7 == IntPtr.Zero) {
                    _d7 = d;
                    _p7 = p;
                }
        ...
        public static cef_x509certificate_t *get_x509certificate(cef_sslstatus_t *self) {
            ...
            if (p == _p8) {
                ...
                d = (get_x509certificate_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_x509certificate_delegate));
                if (_p8 == IntPtr.Zero) {
                    _d8 = d;
                    _p8 = p;
                }
