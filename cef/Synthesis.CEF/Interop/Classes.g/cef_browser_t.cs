...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_browser_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void get_frame_identifiers_delegate(
            cef_browser_t *self, UIntPtr *identifiersCount, long *identifiers);
        ...
        public static void reload_ignore_cache(cef_browser_t *self) {
            ...
            if (p == _pc) {
                ...
                d = (reload_ignore_cache_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(reload_ignore_cache_delegate));
                if (_pc == IntPtr.Zero) {
                    _dc = d;
                    _pc = p;
                }
        ...
        public static cef_frame_t *get_focused_frame(cef_browser_t *self) {
            ...
            if (p == _p13) {
                ...
                d = (get_focused_frame_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_focused_frame_delegate));
                if (_p13 == IntPtr.Zero) {
                    _d13 = d;
                    _p13 = p;
                }
        ...
        public static cef_frame_t *get_frame_byident(cef_browser_t *self, long identifier) {
            ...
            if (p == _p14) {
                ...
                d = (get_frame_byident_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_frame_byident_delegate));
                if (_p14 == IntPtr.Zero) {
                    _d14 = d;
                    _p14 = p;
                }
        ...
        public static UIntPtr get_frame_count(cef_browser_t *self) {
            ...
            if (p == _p16) {
                ...
                d = (get_frame_count_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_frame_count_delegate));
                if (_p16 == IntPtr.Zero) {
                    _d16 = d;
                    _p16 = p;
                }
        ...
        public static void get_frame_identifiers(cef_browser_t *self, UIntPtr *identifiersCount, long *identifiers) {
            ...
            if (p == _p17) {
                ...
                d = (get_frame_identifiers_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_frame_identifiers_delegate));
                if (_p17 == IntPtr.Zero) {
                    _d17 = d;
                    _p17 = p;
                }
        ...
        public static void get_frame_names(cef_browser_t *self, cef_string_list *names) {
            ...
            if (p == _p18) {
                ...
                d = (get_frame_names_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_frame_names_delegate));
                if (_p18 == IntPtr.Zero) {
                    _d18 = d;
                    _p18 = p;
                }
