...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_life_span_handler_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int on_before_popup_delegate(cef_life_span_handler_t *self, cef_browser_t *browser,
            cef_frame_t *frame, cef_string_t *target_url, cef_string_t *target_frame_name,
            CefWindowOpenDisposition target_disposition, int user_gesture, cef_popup_features_t *popupFeatures,
