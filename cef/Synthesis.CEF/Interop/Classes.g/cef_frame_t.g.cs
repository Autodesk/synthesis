...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_frame_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void execute_java_script_delegate(
            cef_frame_t *self, cef_string_t *code, cef_string_t *script_url, int start_line);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate cef_urlrequest_t *create_urlrequest_delegate(
            cef_frame_t *self, cef_request_t *request, cef_urlrequest_client_t *client);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void send_process_message_delegate(
            cef_frame_t *self, CefProcessId target_process, cef_process_message_t *message);
        ...
        public static void execute_java_script(
            cef_frame_t *self, cef_string_t *code, cef_string_t *script_url, int start_line) {
            ...
            if (p == _p11) {
                ...
                d = (execute_java_script_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(execute_java_script_delegate));
                if (_p11 == IntPtr.Zero) {
                    _d11 = d;
                    _p11 = p;
                }
        ...
        public static cef_urlrequest_t *create_urlrequest(
            cef_frame_t *self, cef_request_t *request, cef_urlrequest_client_t *client) {
            ...
            if (p == _p1b) {
                ...
                d = (create_urlrequest_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(create_urlrequest_delegate));
                if (_p1b == IntPtr.Zero) {
                    _d1b = d;
                    _p1b = p;
                }
        ...
        public static void send_process_message(
            cef_frame_t *self, CefProcessId target_process, cef_process_message_t *message) {
            ...
            if (p == _p1c) {
                ...
                d = (send_process_message_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(send_process_message_delegate));
                if (_p1c == IntPtr.Zero) {
                    _d1c = d;
                    _p1c = p;
                }
