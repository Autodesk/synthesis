...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_resource_request_handler_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate cef_cookie_access_filter_t *get_cookie_access_filter_delegate(
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate CefReturnValue on_before_resource_load_delegate(cef_resource_request_handler_t *self,
            cef_browser_t *browser, cef_frame_t *frame, cef_request_t *request, cef_callback_t *callback);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate cef_resource_handler_t *get_resource_handler_delegate(
            cef_resource_request_handler_t *self, cef_browser_t *browser, cef_frame_t *frame, cef_request_t *request);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_resource_redirect_delegate(cef_resource_request_handler_t *self,
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int on_resource_response_delegate(cef_resource_request_handler_t *self,
            cef_browser_t *browser, cef_frame_t *frame, cef_request_t *request, cef_response_t *response);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate cef_response_filter_t *get_resource_response_filter_delegate(
            cef_resource_request_handler_t *self, cef_browser_t *browser, cef_frame_t *frame, cef_request_t *request,
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_resource_load_complete_delegate(cef_resource_request_handler_t *self,
            cef_browser_t *browser, cef_frame_t *frame, cef_request_t *request, cef_response_t *response,
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_protocol_execution_delegate(cef_resource_request_handler_t *self,
            cef_browser_t *browser, cef_frame_t *frame, cef_request_t *request, int *allow_os_execution);
