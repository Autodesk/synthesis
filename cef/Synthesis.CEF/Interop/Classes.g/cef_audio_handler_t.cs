...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_audio_handler_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int get_audio_parameters_delegate(
            cef_audio_handler_t *self, cef_browser_t *browser, cef_audio_parameters_t *@params);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_audio_stream_started_delegate(
            cef_audio_handler_t *self, cef_browser_t *browser, cef_audio_parameters_t *@params, int channels);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_audio_stream_packet_delegate(
            cef_audio_handler_t *self, cef_browser_t *browser, float **data, int frames, long pts);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_audio_stream_error_delegate(
            cef_audio_handler_t *self, cef_browser_t *browser, cef_string_t *message);
