...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_response_filter_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate CefResponseFilterStatus filter_delegate(cef_response_filter_t *self, void *data_in,
            UIntPtr data_in_size, UIntPtr *data_in_read, void *data_out, UIntPtr data_out_size,
            UIntPtr *data_out_written);
