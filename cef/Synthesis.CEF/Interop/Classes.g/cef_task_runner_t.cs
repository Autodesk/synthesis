...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_task_runner_t {
        ...
        // GetForCurrentThread
        [DllImport(
            libcef.DllName, EntryPoint = "cef_task_runner_get_for_current_thread", CallingConvention = libcef.CEF_CALL)]
        ...
        public static int belongs_to_current_thread(cef_task_runner_t *self) {
            ...
            if (p == _p5) {
                ...
                d = (belongs_to_current_thread_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(belongs_to_current_thread_delegate));
                if (_p5 == IntPtr.Zero) {
                    _d5 = d;
                    _p5 = p;
                }
        ...
        public static int belongs_to_thread(cef_task_runner_t *self, CefThreadId threadId) {
            ...
            if (p == _p6) {
                ...
                d = (belongs_to_thread_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(belongs_to_thread_delegate));
                if (_p6 == IntPtr.Zero) {
                    _d6 = d;
                    _p6 = p;
                }
        ...
        public static int post_delayed_task(cef_task_runner_t *self, cef_task_t *task, long delay_ms) {
            ...
            if (p == _p8) {
                ...
                d = (post_delayed_task_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(post_delayed_task_delegate));
                if (_p8 == IntPtr.Zero) {
                    _d8 = d;
                    _p8 = p;
                }
