...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_v8context_t {
        ...
        // GetCurrentContext
        [DllImport(
            libcef.DllName, EntryPoint = "cef_v8context_get_current_context", CallingConvention = libcef.CEF_CALL)]
        public static extern cef_v8context_t *get_current_context();

        // GetEnteredContext
        [DllImport(
            libcef.DllName, EntryPoint = "cef_v8context_get_entered_context", CallingConvention = libcef.CEF_CALL)]
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate int eval_delegate(cef_v8context_t *self, cef_string_t *code, cef_string_t *script_url,
            int start_line, cef_v8value_t **retval, cef_v8exception_t **exception);
        ...
        public static int eval(cef_v8context_t *self, cef_string_t *code, cef_string_t *script_url, int start_line,
            cef_v8value_t **retval, cef_v8exception_t **exception) {
            eval_delegate d;
            var p = self->_eval;
            if (p == _pc) {
                d = _dc;
