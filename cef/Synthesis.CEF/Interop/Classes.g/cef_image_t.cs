...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_image_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate int add_bitmap_delegate(cef_image_t *self, float scale_factor, int pixel_width,
            int pixel_height, CefColorType color_type, CefAlphaType alpha_type, void *pixel_data,
            UIntPtr pixel_data_size);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate int add_png_delegate(
            cef_image_t *self, float scale_factor, void *png_data, UIntPtr png_data_size);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate int add_jpeg_delegate(
            cef_image_t *self, float scale_factor, void *jpeg_data, UIntPtr jpeg_data_size);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate int get_representation_info_delegate(
            cef_image_t *self, float scale_factor, float *actual_scale_factor, int *pixel_width, int *pixel_height);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate cef_binary_value_t *get_as_bitmap_delegate(cef_image_t *self, float scale_factor,
            CefColorType color_type, CefAlphaType alpha_type, int *pixel_width, int *pixel_height);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate cef_binary_value_t *get_as_png_delegate(
            cef_image_t *self, float scale_factor, int with_transparency, int *pixel_width, int *pixel_height);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate cef_binary_value_t *get_as_jpeg_delegate(
            cef_image_t *self, float scale_factor, int quality, int *pixel_width, int *pixel_height);
        ...
        public static int add_bitmap(cef_image_t *self, float scale_factor, int pixel_width, int pixel_height,
            CefColorType color_type, CefAlphaType alpha_type, void *pixel_data, UIntPtr pixel_data_size) {
            ...
            return d(
                self, scale_factor, pixel_width, pixel_height, color_type, alpha_type, pixel_data, pixel_data_size);
        }
        ...
        public static int has_representation(cef_image_t *self, float scale_factor) {
            ...
            if (p == _pb) {
                ...
                d = (has_representation_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(has_representation_delegate));
                if (_pb == IntPtr.Zero) {
                    _db = d;
                    _pb = p;
                }
        ...
        public static int remove_representation(cef_image_t *self, float scale_factor) {
            ...
            if (p == _pc) {
                ...
                d = (remove_representation_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(remove_representation_delegate));
                if (_pc == IntPtr.Zero) {
                    _dc = d;
                    _pc = p;
                }
        ...
        public static int get_representation_info(
            cef_image_t *self, float scale_factor, float *actual_scale_factor, int *pixel_width, int *pixel_height) {
            ...
            if (p == _pd) {
                ...
                d = (get_representation_info_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_representation_info_delegate));
                if (_pd == IntPtr.Zero) {
                    _dd = d;
                    _pd = p;
                }
        ...
        public static cef_binary_value_t *get_as_bitmap(cef_image_t *self, float scale_factor, CefColorType color_type,
            CefAlphaType alpha_type, int *pixel_width, int *pixel_height) {
        ...
        public static cef_binary_value_t *get_as_png(
            cef_image_t *self, float scale_factor, int with_transparency, int *pixel_width, int *pixel_height) {
        ...
        public static cef_binary_value_t *get_as_jpeg(
            cef_image_t *self, float scale_factor, int quality, int *pixel_width, int *pixel_height) {
