...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_server_handler_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_client_connected_delegate(
            cef_server_handler_t *self, cef_server_t *server, int connection_id);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_client_disconnected_delegate(
            cef_server_handler_t *self, cef_server_t *server, int connection_id);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_http_request_delegate(cef_server_handler_t *self, cef_server_t *server,
            int connection_id, cef_string_t *client_address, cef_request_t *request);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_web_socket_request_delegate(cef_server_handler_t *self, cef_server_t *server,
            int connection_id, cef_string_t *client_address, cef_request_t *request, cef_callback_t *callback);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_web_socket_connected_delegate(
            cef_server_handler_t *self, cef_server_t *server, int connection_id);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_web_socket_message_delegate(
            cef_server_handler_t *self, cef_server_t *server, int connection_id, void *data, UIntPtr data_size);
