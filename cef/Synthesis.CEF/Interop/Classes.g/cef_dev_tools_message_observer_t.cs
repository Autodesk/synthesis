...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_dev_tools_message_observer_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int on_dev_tools_message_delegate(
            cef_dev_tools_message_observer_t *self, cef_browser_t *browser, void *message, UIntPtr message_size);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_dev_tools_method_result_delegate(cef_dev_tools_message_observer_t *self,
            cef_browser_t *browser, int message_id, int success, void *result, UIntPtr result_size);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_dev_tools_event_delegate(cef_dev_tools_message_observer_t *self,
            cef_browser_t *browser, cef_string_t *method, void *@params, UIntPtr params_size);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_dev_tools_agent_attached_delegate(
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_dev_tools_agent_detached_delegate(
            cef_dev_tools_message_observer_t *self, cef_browser_t *browser);
