    ...
    internal unsafe struct cef_drag_data_t {
        ...
        public static cef_string_userfree *get_link_metadata(cef_drag_data_t *self) {
            ...
            if (p == _pb) {
                ...
                d = (get_link_metadata_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_link_metadata_delegate));
                if (_pb == IntPtr.Zero) {
                    _db = d;
                    _pb = p;
                }
        ...
        public static cef_string_userfree *get_fragment_text(cef_drag_data_t *self) {
            ...
            if (p == _pc) {
                ...
                d = (get_fragment_text_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_fragment_text_delegate));
                if (_pc == IntPtr.Zero) {
                    _dc = d;
                    _pc = p;
                }
        ...
        public static cef_string_userfree *get_fragment_html(cef_drag_data_t *self) {
            ...
            if (p == _pd) {
                ...
                d = (get_fragment_html_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_fragment_html_delegate));
                if (_pd == IntPtr.Zero) {
                    _dd = d;
                    _pd = p;
                }
        ...
        public static cef_string_userfree *get_fragment_base_url(cef_drag_data_t *self) {
            ...
            if (p == _pe) {
                ...
                d = (get_fragment_base_url_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_fragment_base_url_delegate));
                if (_pe == IntPtr.Zero) {
                    _de = d;
                    _pe = p;
                }
        ...
        public static UIntPtr get_file_contents(cef_drag_data_t *self, cef_stream_writer_t *writer) {
            ...
            if (p == _p10) {
                ...
                d = (get_file_contents_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_file_contents_delegate));
                if (_p10 == IntPtr.Zero) {
                    _d10 = d;
                    _p10 = p;
                }
        ...
        public static void set_link_metadata(cef_drag_data_t *self, cef_string_t *data) {
            ...
            if (p == _p14) {
                ...
                d = (set_link_metadata_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(set_link_metadata_delegate));
                if (_p14 == IntPtr.Zero) {
                    _d14 = d;
                    _p14 = p;
                }
        ...
        public static void set_fragment_text(cef_drag_data_t *self, cef_string_t *text) {
            ...
            if (p == _p15) {
                ...
                d = (set_fragment_text_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(set_fragment_text_delegate));
                if (_p15 == IntPtr.Zero) {
                    _d15 = d;
                    _p15 = p;
                }
        ...
        public static void set_fragment_html(cef_drag_data_t *self, cef_string_t *html) {
            ...
            if (p == _p16) {
                ...
                d = (set_fragment_html_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(set_fragment_html_delegate));
                if (_p16 == IntPtr.Zero) {
                    _d16 = d;
                    _p16 = p;
                }
        ...
        public static void set_fragment_base_url(cef_drag_data_t *self, cef_string_t *base_url) {
            ...
            if (p == _p17) {
                ...
                d = (set_fragment_base_url_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(set_fragment_base_url_delegate));
                if (_p17 == IntPtr.Zero) {
                    _d17 = d;
                    _p17 = p;
                }
        ...
        public static void reset_file_contents(cef_drag_data_t *self) {
            ...
            if (p == _p18) {
                ...
                d = (reset_file_contents_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(reset_file_contents_delegate));
                if (_p18 == IntPtr.Zero) {
                    _d18 = d;
                    _p18 = p;
                }
        ...
        public static void clear_filenames(cef_drag_data_t *self) {
            ...
            if (p == _p1a) {
                ...
                d = (clear_filenames_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(clear_filenames_delegate));
                if (_p1a == IntPtr.Zero) {
                    _d1a = d;
                    _p1a = p;
                }
        ...
        public static cef_point_t get_image_hotspot(cef_drag_data_t *self) {
            ...
            if (p == _p1c) {
                ...
                d = (get_image_hotspot_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_image_hotspot_delegate));
                if (_p1c == IntPtr.Zero) {
                    _d1c = d;
                    _p1c = p;
                }
