...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_media_router_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate cef_registration_t *add_observer_delegate(
            cef_media_router_t *self, cef_media_observer_t *observer);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void create_route_delegate(cef_media_router_t *self, cef_media_source_t *source,
            cef_media_sink_t *sink, cef_media_route_create_callback_t *callback);
        ...
        public static void notify_current_sinks(cef_media_router_t *self) {
            ...
            if (p == _p6) {
                ...
                d = (notify_current_sinks_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(notify_current_sinks_delegate));
                if (_p6 == IntPtr.Zero) {
                    _d6 = d;
                    _p6 = p;
                }
        ...
        public static void create_route(cef_media_router_t *self, cef_media_source_t *source, cef_media_sink_t *sink,
        ...
        public static void notify_current_routes(cef_media_router_t *self) {
            ...
            if (p == _p8) {
                ...
                d = (notify_current_routes_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(notify_current_routes_delegate));
                if (_p8 == IntPtr.Zero) {
                    _d8 = d;
                    _p8 = p;
                }
