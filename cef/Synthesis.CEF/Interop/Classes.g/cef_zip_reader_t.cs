    ...
    internal unsafe struct cef_zip_reader_t {
        ...
        public static int move_to_first_file(cef_zip_reader_t *self) {
            ...
            if (p == _p4) {
                ...
                d = (move_to_first_file_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(move_to_first_file_delegate));
                if (_p4 == IntPtr.Zero) {
                    _d4 = d;
                    _p4 = p;
                }
        ...
        public static int move_to_next_file(cef_zip_reader_t *self) {
            ...
            if (p == _p5) {
                ...
                d = (move_to_next_file_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(move_to_next_file_delegate));
                if (_p5 == IntPtr.Zero) {
                    _d5 = d;
                    _p5 = p;
                }
        ...
        public static CefBaseTime get_file_last_modified(cef_zip_reader_t *self) {
            ...
            if (p == _pa) {
                ...
                d = (get_file_last_modified_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_file_last_modified_delegate));
                if (_pa == IntPtr.Zero) {
                    _da = d;
                    _pa = p;
                }
