...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_resource_handler_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int open_delegate(
            cef_resource_handler_t *self, cef_request_t *request, int *handle_request, cef_callback_t *callback);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int process_request_delegate(
            cef_resource_handler_t *self, cef_request_t *request, cef_callback_t *callback);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void get_response_headers_delegate(
            cef_resource_handler_t *self, cef_response_t *response, long *response_length, cef_string_t *redirectUrl);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int skip_delegate(cef_resource_handler_t *self, long bytes_to_skip, long *bytes_skipped,
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int read_delegate(cef_resource_handler_t *self, void *data_out, int bytes_to_read,
            int *bytes_read, cef_resource_read_callback_t *callback);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int read_response_delegate(
            cef_resource_handler_t *self, void *data_out, int bytes_to_read, int *bytes_read, cef_callback_t *callback);
