...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_client_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int on_process_message_received_delegate(cef_client_t *self, cef_browser_t *browser,
            cef_frame_t *frame, CefProcessId source_process, cef_process_message_t *message);
