...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_v8handler_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int execute_delegate(cef_v8handler_t *self, cef_string_t *name, cef_v8value_t *@object,
            UIntPtr argumentsCount, cef_v8value_t **arguments, cef_v8value_t **retval, cef_string_t *exception);
