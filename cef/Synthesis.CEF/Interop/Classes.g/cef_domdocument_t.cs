...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_domdocument_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate cef_string_userfree *get_complete_url_delegate(
            cef_domdocument_t *self, cef_string_t *partialURL);
        ...
        public static cef_domnode_t *get_element_by_id(cef_domdocument_t *self, cef_string_t *id) {
            ...
            if (p == _p9) {
                ...
                d = (get_element_by_id_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_element_by_id_delegate));
                if (_p9 == IntPtr.Zero) {
                    _d9 = d;
                    _p9 = p;
                }
        ...
        public static cef_domnode_t *get_focused_node(cef_domdocument_t *self) {
            ...
            if (p == _pa) {
                ...
                d = (get_focused_node_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_focused_node_delegate));
                if (_pa == IntPtr.Zero) {
                    _da = d;
                    _pa = p;
                }
        ...
        public static int get_selection_start_offset(cef_domdocument_t *self) {
            ...
            if (p == _pc) {
                ...
                d = (get_selection_start_offset_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_selection_start_offset_delegate));
                if (_pc == IntPtr.Zero) {
                    _dc = d;
                    _pc = p;
                }
        ...
        public static int get_selection_end_offset(cef_domdocument_t *self) {
            ...
            if (p == _pd) {
                ...
                d = (get_selection_end_offset_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_selection_end_offset_delegate));
                if (_pd == IntPtr.Zero) {
                    _dd = d;
                    _pd = p;
                }
        ...
        public static cef_string_userfree *get_selection_as_markup(cef_domdocument_t *self) {
            ...
            if (p == _pe) {
                ...
                d = (get_selection_as_markup_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_selection_as_markup_delegate));
                if (_pe == IntPtr.Zero) {
                    _de = d;
                    _pe = p;
                }
        ...
        public static cef_string_userfree *get_selection_as_text(cef_domdocument_t *self) {
            ...
            if (p == _pf) {
                ...
                d = (get_selection_as_text_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_selection_as_text_delegate));
                if (_pf == IntPtr.Zero) {
                    _df = d;
                    _pf = p;
                }
        ...
        public static cef_string_userfree *get_complete_url(cef_domdocument_t *self, cef_string_t *partialURL) {
            ...
            if (p == _p11) {
                ...
                d = (get_complete_url_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_complete_url_delegate));
                if (_p11 == IntPtr.Zero) {
                    _d11 = d;
                    _p11 = p;
                }
