...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_render_handler_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int get_root_screen_rect_delegate(
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void get_view_rect_delegate(
            cef_render_handler_t *self, cef_browser_t *browser, cef_rect_t *rect);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int get_screen_point_delegate(
            cef_render_handler_t *self, cef_browser_t *browser, int viewX, int viewY, int *screenX, int *screenY);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int get_screen_info_delegate(
            cef_render_handler_t *self, cef_browser_t *browser, cef_screen_info_t *screen_info);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_popup_size_delegate(
            cef_render_handler_t *self, cef_browser_t *browser, cef_rect_t *rect);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_paint_delegate(cef_render_handler_t *self, cef_browser_t *browser,
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_accelerated_paint_delegate(cef_render_handler_t *self, cef_browser_t *browser,
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void get_touch_handle_size_delegate(
            cef_render_handler_t *self, cef_browser_t *browser, CefHorizontalAlignment orientation, cef_size_t *size);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_touch_handle_state_changed_delegate(
            cef_render_handler_t *self, cef_browser_t *browser, cef_touch_handle_state_t *state);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int start_dragging_delegate(cef_render_handler_t *self, cef_browser_t *browser,
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void update_drag_cursor_delegate(
            cef_render_handler_t *self, cef_browser_t *browser, CefDragOperationsMask operation);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_scroll_offset_changed_delegate(
            cef_render_handler_t *self, cef_browser_t *browser, double x, double y);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_ime_composition_range_changed_delegate(cef_render_handler_t *self,
            cef_browser_t *browser, cef_range_t *selected_range, UIntPtr character_boundsCount,
            cef_rect_t *character_bounds);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_text_selection_changed_delegate(cef_render_handler_t *self, cef_browser_t *browser,
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_virtual_keyboard_requested_delegate(
            cef_render_handler_t *self, cef_browser_t *browser, CefTextInputMode input_mode);
