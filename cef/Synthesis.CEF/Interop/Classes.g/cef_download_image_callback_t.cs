...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_download_image_callback_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_download_image_finished_delegate(
            cef_download_image_callback_t *self, cef_string_t *image_url, int http_status_code, cef_image_t *image);
