...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_xml_reader_t {
        ...
        public static extern cef_xml_reader_t *create(
            cef_stream_reader_t *stream, CefXmlEncoding encodingType, cef_string_t *URI);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate cef_string_userfree *get_attribute_byqname_delegate(
            cef_xml_reader_t *self, cef_string_t *qualifiedName);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate cef_string_userfree *get_attribute_bylname_delegate(
            cef_xml_reader_t *self, cef_string_t *localName, cef_string_t *namespaceURI);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate int move_to_attribute_bylname_delegate(
            cef_xml_reader_t *self, cef_string_t *localName, cef_string_t *namespaceURI);
        ...
        public static int move_to_next_node(cef_xml_reader_t *self) {
            ...
            if (p == _p4) {
                ...
                d = (move_to_next_node_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(move_to_next_node_delegate));
                if (_p4 == IntPtr.Zero) {
                    _d4 = d;
                    _p4 = p;
                }
        ...
        public static cef_string_userfree *get_qualified_name(cef_xml_reader_t *self) {
            ...
            if (p == _pc) {
                ...
                d = (get_qualified_name_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_qualified_name_delegate));
                if (_pc == IntPtr.Zero) {
                    _dc = d;
                    _pc = p;
                }
        ...
        public static cef_string_userfree *get_namespace_uri(cef_xml_reader_t *self) {
            ...
            if (p == _pd) {
                ...
                d = (get_namespace_uri_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_namespace_uri_delegate));
                if (_pd == IntPtr.Zero) {
                    _dd = d;
                    _pd = p;
                }
        ...
        public static int is_empty_element(cef_xml_reader_t *self) {
            ...
            if (p == _p10) {
                ...
                d = (is_empty_element_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(is_empty_element_delegate));
                if (_p10 == IntPtr.Zero) {
                    _d10 = d;
                    _p10 = p;
                }
        ...
        public static UIntPtr get_attribute_count(cef_xml_reader_t *self) {
            ...
            if (p == _p14) {
                ...
                d = (get_attribute_count_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_attribute_count_delegate));
                if (_p14 == IntPtr.Zero) {
                    _d14 = d;
                    _p14 = p;
                }
        ...
        public static cef_string_userfree *get_attribute_byindex(cef_xml_reader_t *self, int index) {
            ...
            if (p == _p15) {
                ...
                d = (get_attribute_byindex_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_attribute_byindex_delegate));
                if (_p15 == IntPtr.Zero) {
                    _d15 = d;
                    _p15 = p;
                }
        ...
        public static cef_string_userfree *get_attribute_byqname(cef_xml_reader_t *self, cef_string_t *qualifiedName) {
            ...
            if (p == _p16) {
                ...
                d = (get_attribute_byqname_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_attribute_byqname_delegate));
                if (_p16 == IntPtr.Zero) {
                    _d16 = d;
                    _p16 = p;
                }
        ...
        public static cef_string_userfree *get_attribute_bylname(
            cef_xml_reader_t *self, cef_string_t *localName, cef_string_t *namespaceURI) {
            ...
            if (p == _p17) {
                ...
                d = (get_attribute_bylname_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_attribute_bylname_delegate));
                if (_p17 == IntPtr.Zero) {
                    _d17 = d;
                    _p17 = p;
                }
        ...
        public static int get_line_number(cef_xml_reader_t *self) {
            ...
            if (p == _p1a) {
                ...
                d = (get_line_number_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_line_number_delegate));
                if (_p1a == IntPtr.Zero) {
                    _d1a = d;
                    _p1a = p;
                }
        ...
        public static int move_to_attribute_byindex(cef_xml_reader_t *self, int index) {
            ...
            if (p == _p1b) {
                ...
                d = (move_to_attribute_byindex_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(move_to_attribute_byindex_delegate));
                if (_p1b == IntPtr.Zero) {
                    _d1b = d;
                    _p1b = p;
                }
        ...
        public static int move_to_attribute_byqname(cef_xml_reader_t *self, cef_string_t *qualifiedName) {
            ...
            if (p == _p1c) {
                ...
                d = (move_to_attribute_byqname_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(move_to_attribute_byqname_delegate));
                if (_p1c == IntPtr.Zero) {
                    _d1c = d;
                    _p1c = p;
                }
        ...
        public static int move_to_attribute_bylname(
            cef_xml_reader_t *self, cef_string_t *localName, cef_string_t *namespaceURI) {
            ...
            if (p == _p1d) {
                ...
                d = (move_to_attribute_bylname_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(move_to_attribute_bylname_delegate));
                if (_p1d == IntPtr.Zero) {
                    _d1d = d;
                    _p1d = p;
                }
        ...
        public static int move_to_first_attribute(cef_xml_reader_t *self) {
            ...
            if (p == _p1e) {
                ...
                d = (move_to_first_attribute_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(move_to_first_attribute_delegate));
                if (_p1e == IntPtr.Zero) {
                    _d1e = d;
                    _p1e = p;
                }
        ...
        public static int move_to_next_attribute(cef_xml_reader_t *self) {
            ...
            if (p == _p1f) {
                ...
                d = (move_to_next_attribute_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(move_to_next_attribute_delegate));
                if (_p1f == IntPtr.Zero) {
                    _d1f = d;
                    _p1f = p;
                }
        ...
        public static int move_to_carrying_element(cef_xml_reader_t *self) {
            ...
            if (p == _p20) {
                ...
                d = (move_to_carrying_element_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(move_to_carrying_element_delegate));
                if (_p20 == IntPtr.Zero) {
                    _d20 = d;
                    _p20 = p;
                }
