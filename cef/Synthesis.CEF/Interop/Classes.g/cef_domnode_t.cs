...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_domnode_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate cef_string_userfree *get_element_attribute_delegate(
            cef_domnode_t *self, cef_string_t *attrName);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate int set_element_attribute_delegate(
            cef_domnode_t *self, cef_string_t *attrName, cef_string_t *value);
        ...
        public static int is_form_control_element(cef_domnode_t *self) {
            ...
            if (p == _p8) {
                ...
                d = (is_form_control_element_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(is_form_control_element_delegate));
                if (_p8 == IntPtr.Zero) {
                    _d8 = d;
                    _p8 = p;
                }
        ...
        public static cef_string_userfree *get_form_control_element_type(cef_domnode_t *self) {
            ...
            if (p == _p9) {
                ...
                d = (get_form_control_element_type_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_form_control_element_type_delegate));
                if (_p9 == IntPtr.Zero) {
                    _d9 = d;
                    _p9 = p;
                }
        ...
        public static cef_domnode_t *get_previous_sibling(cef_domnode_t *self) {
            ...
            if (p == _p11) {
                ...
                d = (get_previous_sibling_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_previous_sibling_delegate));
                if (_p11 == IntPtr.Zero) {
                    _d11 = d;
                    _p11 = p;
                }
        ...
        public static cef_domnode_t *get_next_sibling(cef_domnode_t *self) {
            ...
            if (p == _p12) {
                ...
                d = (get_next_sibling_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_next_sibling_delegate));
                if (_p12 == IntPtr.Zero) {
                    _d12 = d;
                    _p12 = p;
                }
        ...
        public static cef_domnode_t *get_first_child(cef_domnode_t *self) {
            ...
            if (p == _p14) {
                ...
                d = (get_first_child_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_first_child_delegate));
                if (_p14 == IntPtr.Zero) {
                    _d14 = d;
                    _p14 = p;
                }
        ...
        public static cef_string_userfree *get_element_tag_name(cef_domnode_t *self) {
            ...
            if (p == _p16) {
                ...
                d = (get_element_tag_name_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_element_tag_name_delegate));
                if (_p16 == IntPtr.Zero) {
                    _d16 = d;
                    _p16 = p;
                }
        ...
        public static int has_element_attributes(cef_domnode_t *self) {
            ...
            if (p == _p17) {
                ...
                d = (has_element_attributes_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(has_element_attributes_delegate));
                if (_p17 == IntPtr.Zero) {
                    _d17 = d;
                    _p17 = p;
                }
        ...
        public static int has_element_attribute(cef_domnode_t *self, cef_string_t *attrName) {
            ...
            if (p == _p18) {
                ...
                d = (has_element_attribute_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(has_element_attribute_delegate));
                if (_p18 == IntPtr.Zero) {
                    _d18 = d;
                    _p18 = p;
                }
        ...
        public static cef_string_userfree *get_element_attribute(cef_domnode_t *self, cef_string_t *attrName) {
            ...
            if (p == _p19) {
                ...
                d = (get_element_attribute_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_element_attribute_delegate));
                if (_p19 == IntPtr.Zero) {
                    _d19 = d;
                    _p19 = p;
                }
        ...
        public static void get_element_attributes(cef_domnode_t *self, cef_string_map *attrMap) {
            ...
            if (p == _p1a) {
                ...
                d = (get_element_attributes_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_element_attributes_delegate));
                if (_p1a == IntPtr.Zero) {
                    _d1a = d;
                    _p1a = p;
                }
        ...
        public static int set_element_attribute(cef_domnode_t *self, cef_string_t *attrName, cef_string_t *value) {
            ...
            if (p == _p1b) {
                ...
                d = (set_element_attribute_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(set_element_attribute_delegate));
                if (_p1b == IntPtr.Zero) {
                    _d1b = d;
                    _p1b = p;
                }
        ...
        public static cef_string_userfree *get_element_inner_text(cef_domnode_t *self) {
            ...
            if (p == _p1c) {
                ...
                d = (get_element_inner_text_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_element_inner_text_delegate));
                if (_p1c == IntPtr.Zero) {
                    _d1c = d;
                    _p1c = p;
                }
        ...
        public static cef_rect_t get_element_bounds(cef_domnode_t *self) {
            ...
            if (p == _p1d) {
                ...
                d = (get_element_bounds_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_element_bounds_delegate));
                if (_p1d == IntPtr.Zero) {
                    _d1d = d;
                    _p1d = p;
                }
