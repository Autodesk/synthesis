...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_print_handler_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_print_settings_delegate(
            cef_print_handler_t *self, cef_browser_t *browser, cef_print_settings_t *settings, int get_defaults);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int on_print_dialog_delegate(cef_print_handler_t *self, cef_browser_t *browser,
            int has_selection, cef_print_dialog_callback_t *callback);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int on_print_job_delegate(cef_print_handler_t *self, cef_browser_t *browser,
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate cef_size_t get_pdf_paper_size_delegate(
            cef_print_handler_t *self, cef_browser_t *browser, int device_units_per_inch);
