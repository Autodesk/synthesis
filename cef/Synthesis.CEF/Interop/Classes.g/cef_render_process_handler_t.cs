...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_render_process_handler_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_browser_created_delegate(
            cef_render_process_handler_t *self, cef_browser_t *browser, cef_dictionary_value_t *extra_info);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_browser_destroyed_delegate(
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_context_created_delegate(
            cef_render_process_handler_t *self, cef_browser_t *browser, cef_frame_t *frame, cef_v8context_t *context);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_context_released_delegate(
            cef_render_process_handler_t *self, cef_browser_t *browser, cef_frame_t *frame, cef_v8context_t *context);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_uncaught_exception_delegate(cef_render_process_handler_t *self,
            cef_browser_t *browser, cef_frame_t *frame, cef_v8context_t *context, cef_v8exception_t *exception,
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_focused_node_changed_delegate(
            cef_render_process_handler_t *self, cef_browser_t *browser, cef_frame_t *frame, cef_domnode_t *node);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int on_process_message_received_delegate(cef_render_process_handler_t *self,
            cef_browser_t *browser, cef_frame_t *frame, CefProcessId source_process, cef_process_message_t *message);
