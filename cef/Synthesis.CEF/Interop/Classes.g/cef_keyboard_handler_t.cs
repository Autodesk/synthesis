...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_keyboard_handler_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int on_pre_key_event_delegate(cef_keyboard_handler_t *self, cef_browser_t *browser,
            cef_key_event_t *@event, IntPtr os_event, int *is_keyboard_shortcut);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int on_key_event_delegate(
            cef_keyboard_handler_t *self, cef_browser_t *browser, cef_key_event_t *@event, IntPtr os_event);
