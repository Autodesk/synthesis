...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_x509cert_principal_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void get_organization_unit_names_delegate(
            cef_x509cert_principal_t *self, cef_string_list *names);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void get_domain_components_delegate(
            cef_x509cert_principal_t *self, cef_string_list *components);
        ...
        public static cef_string_userfree *get_display_name(cef_x509cert_principal_t *self) {
            ...
            if (p == _p4) {
                ...
                d = (get_display_name_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_display_name_delegate));
                if (_p4 == IntPtr.Zero) {
                    _d4 = d;
                    _p4 = p;
                }
        ...
        public static cef_string_userfree *get_common_name(cef_x509cert_principal_t *self) {
            ...
            if (p == _p5) {
                ...
                d = (get_common_name_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_common_name_delegate));
                if (_p5 == IntPtr.Zero) {
                    _d5 = d;
                    _p5 = p;
                }
        ...
        public static cef_string_userfree *get_locality_name(cef_x509cert_principal_t *self) {
            ...
            if (p == _p6) {
                ...
                d = (get_locality_name_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_locality_name_delegate));
                if (_p6 == IntPtr.Zero) {
                    _d6 = d;
                    _p6 = p;
                }
        ...
        public static cef_string_userfree *get_state_or_province_name(cef_x509cert_principal_t *self) {
            ...
            if (p == _p7) {
                ...
                d = (get_state_or_province_name_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_state_or_province_name_delegate));
                if (_p7 == IntPtr.Zero) {
                    _d7 = d;
                    _p7 = p;
                }
        ...
        public static cef_string_userfree *get_country_name(cef_x509cert_principal_t *self) {
            ...
            if (p == _p8) {
                ...
                d = (get_country_name_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_country_name_delegate));
                if (_p8 == IntPtr.Zero) {
                    _d8 = d;
                    _p8 = p;
                }
        ...
        public static void get_street_addresses(cef_x509cert_principal_t *self, cef_string_list *addresses) {
            ...
            if (p == _p9) {
                ...
                d = (get_street_addresses_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_street_addresses_delegate));
                if (_p9 == IntPtr.Zero) {
                    _d9 = d;
                    _p9 = p;
                }
        ...
        public static void get_organization_names(cef_x509cert_principal_t *self, cef_string_list *names) {
            ...
            if (p == _pa) {
                ...
                d = (get_organization_names_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_organization_names_delegate));
                if (_pa == IntPtr.Zero) {
                    _da = d;
                    _pa = p;
                }
        ...
        public static void get_organization_unit_names(cef_x509cert_principal_t *self, cef_string_list *names) {
            ...
            if (p == _pb) {
                ...
                d = (get_organization_unit_names_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_organization_unit_names_delegate));
                if (_pb == IntPtr.Zero) {
                    _db = d;
                    _pb = p;
                }
        ...
        public static void get_domain_components(cef_x509cert_principal_t *self, cef_string_list *components) {
            ...
            if (p == _pc) {
                ...
                d = (get_domain_components_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_domain_components_delegate));
                if (_pc == IntPtr.Zero) {
                    _dc = d;
                    _pc = p;
                }
