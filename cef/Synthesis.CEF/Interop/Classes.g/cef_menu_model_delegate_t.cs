...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_menu_model_delegate_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void execute_command_delegate(
            cef_menu_model_delegate_t *self, cef_menu_model_t *menu_model, int command_id, CefEventFlags event_flags);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void mouse_outside_menu_delegate(
            cef_menu_model_delegate_t *self, cef_menu_model_t *menu_model, cef_point_t *screen_point);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void unhandled_open_submenu_delegate(
            cef_menu_model_delegate_t *self, cef_menu_model_t *menu_model, int is_rtl);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void unhandled_close_submenu_delegate(
            cef_menu_model_delegate_t *self, cef_menu_model_t *menu_model, int is_rtl);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int format_label_delegate(
            cef_menu_model_delegate_t *self, cef_menu_model_t *menu_model, cef_string_t *label);
