...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_request_context_t {
        ...
        // GetGlobalContext
        [DllImport(
            libcef.DllName, EntryPoint = "cef_request_context_get_global_context", CallingConvention = libcef.CEF_CALL)]
        public static extern cef_request_context_t *get_global_context();

        // CreateContext
        [DllImport(
            libcef.DllName, EntryPoint = "cef_request_context_create_context", CallingConvention = libcef.CEF_CALL)]
        public static extern cef_request_context_t *create_context(
            cef_request_context_settings_t *settings, cef_request_context_handler_t *handler);

        // CreateContext
        [DllImport(libcef.DllName, EntryPoint = "cef_create_context_shared", CallingConvention = libcef.CEF_CALL)]
        public static extern cef_request_context_t *create_context(
            cef_request_context_t *other, cef_request_context_handler_t *handler);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate cef_cookie_manager_t *get_cookie_manager_delegate(
            cef_request_context_t *self, cef_completion_callback_t *callback);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate int register_scheme_handler_factory_delegate(cef_request_context_t *self,
            cef_string_t *scheme_name, cef_string_t *domain_name, cef_scheme_handler_factory_t *factory);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate cef_dictionary_value_t *get_all_preferences_delegate(
            cef_request_context_t *self, int include_defaults);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate int set_preference_delegate(
            cef_request_context_t *self, cef_string_t *name, cef_value_t *value, cef_string_t *error);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void clear_certificate_exceptions_delegate(
            cef_request_context_t *self, cef_completion_callback_t *callback);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void clear_http_auth_credentials_delegate(
            cef_request_context_t *self, cef_completion_callback_t *callback);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void close_all_connections_delegate(
            cef_request_context_t *self, cef_completion_callback_t *callback);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void resolve_host_delegate(
            cef_request_context_t *self, cef_string_t *origin, cef_resolve_callback_t *callback);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void load_extension_delegate(cef_request_context_t *self, cef_string_t *root_directory,
            cef_dictionary_value_t *manifest, cef_extension_handler_t *handler);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate cef_extension_t *get_extension_delegate(
            cef_request_context_t *self, cef_string_t *extension_id);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate cef_media_router_t *get_media_router_delegate(
            cef_request_context_t *self, cef_completion_callback_t *callback);
        ...
        public static int is_sharing_with(cef_request_context_t *self, cef_request_context_t *other) {
            ...
            if (p == _p5) {
                ...
                d = (is_sharing_with_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(is_sharing_with_delegate));
                if (_p5 == IntPtr.Zero) {
                    _d5 = d;
                    _p5 = p;
                }
        ...
        public static cef_cookie_manager_t *get_cookie_manager(
            cef_request_context_t *self, cef_completion_callback_t *callback) {
            ...
            if (p == _p9) {
                ...
                d = (get_cookie_manager_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_cookie_manager_delegate));
                if (_p9 == IntPtr.Zero) {
                    _d9 = d;
                    _p9 = p;
                }
        ...
        public static int register_scheme_handler_factory(cef_request_context_t *self, cef_string_t *scheme_name,
            cef_string_t *domain_name, cef_scheme_handler_factory_t *factory) {
            register_scheme_handler_factory_delegate d;
            var p = self->_register_scheme_handler_factory;
            if (p == _pa) {
                d = _da;
            } else {
                d = (register_scheme_handler_factory_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(register_scheme_handler_factory_delegate));
                if (_pa == IntPtr.Zero) {
                    _da = d;
                    _pa = p;
                }
        ...
        public static int clear_scheme_handler_factories(cef_request_context_t *self) {
            ...
            if (p == _pb) {
                ...
                d = (clear_scheme_handler_factories_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(clear_scheme_handler_factories_delegate));
                if (_pb == IntPtr.Zero) {
                    _db = d;
                    _pb = p;
                }
        ...
        public static cef_dictionary_value_t *get_all_preferences(cef_request_context_t *self, int include_defaults) {
            ...
            if (p == _pe) {
                ...
                d = (get_all_preferences_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_all_preferences_delegate));
                if (_pe == IntPtr.Zero) {
                    _de = d;
                    _pe = p;
                }
        ...
        public static int can_set_preference(cef_request_context_t *self, cef_string_t *name) {
            ...
            if (p == _pf) {
                ...
                d = (can_set_preference_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(can_set_preference_delegate));
                if (_pf == IntPtr.Zero) {
                    _df = d;
                    _pf = p;
                }
        ...
        public static int set_preference(
            cef_request_context_t *self, cef_string_t *name, cef_value_t *value, cef_string_t *error) {
        ...
        public static void clear_certificate_exceptions(
            cef_request_context_t *self, cef_completion_callback_t *callback) {
            ...
            if (p == _p11) {
                ...
                d = (clear_certificate_exceptions_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(clear_certificate_exceptions_delegate));
                if (_p11 == IntPtr.Zero) {
                    _d11 = d;
                    _p11 = p;
                }
        ...
        public static void clear_http_auth_credentials(
            cef_request_context_t *self, cef_completion_callback_t *callback) {
            ...
            if (p == _p12) {
                ...
                d = (clear_http_auth_credentials_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(clear_http_auth_credentials_delegate));
                if (_p12 == IntPtr.Zero) {
                    _d12 = d;
                    _p12 = p;
                }
        ...
        public static void close_all_connections(cef_request_context_t *self, cef_completion_callback_t *callback) {
            ...
            if (p == _p13) {
                ...
                d = (close_all_connections_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(close_all_connections_delegate));
                if (_p13 == IntPtr.Zero) {
                    _d13 = d;
                    _p13 = p;
                }
        ...
        public static void resolve_host(
            cef_request_context_t *self, cef_string_t *origin, cef_resolve_callback_t *callback) {
        ...
        public static void load_extension(cef_request_context_t *self, cef_string_t *root_directory,
            cef_dictionary_value_t *manifest, cef_extension_handler_t *handler) {
        ...
        public static int did_load_extension(cef_request_context_t *self, cef_string_t *extension_id) {
            ...
            if (p == _p16) {
                ...
                d = (did_load_extension_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(did_load_extension_delegate));
                if (_p16 == IntPtr.Zero) {
                    _d16 = d;
                    _p16 = p;
                }
        ...
        public static cef_media_router_t *get_media_router(
            cef_request_context_t *self, cef_completion_callback_t *callback) {
            ...
            if (p == _p1a) {
                ...
                d = (get_media_router_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_media_router_delegate));
                if (_p1a == IntPtr.Zero) {
                    _d1a = d;
                    _p1a = p;
                }
