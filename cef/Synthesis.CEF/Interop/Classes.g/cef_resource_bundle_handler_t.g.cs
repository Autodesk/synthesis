...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_resource_bundle_handler_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int get_localized_string_delegate(
            cef_resource_bundle_handler_t *self, int string_id, cef_string_t *@string);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int get_data_resource_delegate(
            cef_resource_bundle_handler_t *self, int resource_id, void **data, UIntPtr *data_size);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int get_data_resource_for_scale_delegate(cef_resource_bundle_handler_t *self, int resource_id,
            CefScaleFactor scale_factor, void **data, UIntPtr *data_size);
