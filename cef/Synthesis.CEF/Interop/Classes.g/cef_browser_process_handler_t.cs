...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_browser_process_handler_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_before_child_process_launch_delegate(
            cef_browser_process_handler_t *self, cef_command_line_t *command_line);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate void on_schedule_message_pump_work_delegate(
            cef_browser_process_handler_t *self, long delay_ms);
