    ...
    internal unsafe struct cef_navigation_entry_t {
        ...
        public static cef_string_userfree *get_display_url(cef_navigation_entry_t *self) {
            ...
            if (p == _p6) {
                ...
                d = (get_display_url_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_display_url_delegate));
                if (_p6 == IntPtr.Zero) {
                    _d6 = d;
                    _p6 = p;
                }
        ...
        public static CefBaseTime get_completion_time(cef_navigation_entry_t *self) {
            ...
            if (p == _pb) {
                ...
                d = (get_completion_time_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_completion_time_delegate));
                if (_pb == IntPtr.Zero) {
                    _db = d;
                    _pb = p;
                }
        ...
        public static int get_http_status_code(cef_navigation_entry_t *self) {
            ...
            if (p == _pc) {
                ...
                d = (get_http_status_code_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_http_status_code_delegate));
                if (_pc == IntPtr.Zero) {
                    _dc = d;
                    _pc = p;
                }
