...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_scheme_registrar_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate int add_custom_scheme_delegate(
            cef_scheme_registrar_t *self, cef_string_t *scheme_name, int options);
        ...
        public static int add_custom_scheme(cef_scheme_registrar_t *self, cef_string_t *scheme_name, int options) {
            ...
            if (p == _p1) {
                ...
                d = (add_custom_scheme_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(add_custom_scheme_delegate));
                if (_p1 == IntPtr.Zero) {
                    _d1 = d;
                    _p1 = p;
                }
