...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_command_line_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void append_switch_with_value_delegate(
            cef_command_line_t *self, cef_string_t *name, cef_string_t *value);
        ...
        public static void init_from_string(cef_command_line_t *self, cef_string_t *command_line) {
            ...
            if (p == _p8) {
                ...
                d = (init_from_string_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(init_from_string_delegate));
                if (_p8 == IntPtr.Zero) {
                    _d8 = d;
                    _p8 = p;
                }
        ...
        public static cef_string_userfree *get_command_line_string(cef_command_line_t *self) {
            ...
            if (p == _pb) {
                ...
                d = (get_command_line_string_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_command_line_string_delegate));
                if (_pb == IntPtr.Zero) {
                    _db = d;
                    _pb = p;
                }
        ...
        public static cef_string_userfree *get_switch_value(cef_command_line_t *self, cef_string_t *name) {
            ...
            if (p == _p10) {
                ...
                d = (get_switch_value_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_switch_value_delegate));
                if (_p10 == IntPtr.Zero) {
                    _d10 = d;
                    _p10 = p;
                }
        ...
        public static void append_switch_with_value(cef_command_line_t *self, cef_string_t *name, cef_string_t *value) {
            ...
            if (p == _p13) {
                ...
                d = (append_switch_with_value_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(append_switch_with_value_delegate));
                if (_p13 == IntPtr.Zero) {
                    _d13 = d;
                    _p13 = p;
                }
        ...
        public static void append_argument(cef_command_line_t *self, cef_string_t *argument) {
            ...
            if (p == _p16) {
                ...
                d = (append_argument_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(append_argument_delegate));
                if (_p16 == IntPtr.Zero) {
                    _d16 = d;
                    _p16 = p;
                }
        ...
        public static void prepend_wrapper(cef_command_line_t *self, cef_string_t *wrapper) {
            ...
            if (p == _p17) {
                ...
                d = (prepend_wrapper_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(prepend_wrapper_delegate));
                if (_p17 == IntPtr.Zero) {
                    _d17 = d;
                    _p17 = p;
                }
