...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_media_sink_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate void get_device_info_delegate(
            cef_media_sink_t *self, cef_media_sink_device_info_callback_t *callback);
        ...
        public static cef_string_userfree *get_description(cef_media_sink_t *self) {
            ...
            if (p == _p6) {
                ...
                d = (get_description_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_description_delegate));
                if (_p6 == IntPtr.Zero) {
                    _d6 = d;
                    _p6 = p;
                }
        ...
        public static void get_device_info(cef_media_sink_t *self, cef_media_sink_device_info_callback_t *callback) {
            ...
            if (p == _p8) {
                ...
                d = (get_device_info_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(get_device_info_delegate));
                if (_p8 == IntPtr.Zero) {
                    _d8 = d;
                    _p8 = p;
                }
        ...
        public static int is_compatible_with(cef_media_sink_t *self, cef_media_source_t *source) {
            ...
            if (p == _pb) {
                ...
                d = (is_compatible_with_delegate) Marshal.GetDelegateForFunctionPointer(
                    p, typeof(is_compatible_with_delegate));
                if (_pb == IntPtr.Zero) {
                    _db = d;
                    _pb = p;
                }
