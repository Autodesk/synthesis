...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_dictionary_value_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate cef_dictionary_value_t *copy_delegate(
            cef_dictionary_value_t *self, int exclude_empty_children);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate cef_dictionary_value_t *get_dictionary_delegate(
            cef_dictionary_value_t *self, cef_string_t *key);
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate int set_binary_delegate(
            cef_dictionary_value_t *self, cef_string_t *key, cef_binary_value_t *value);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate int set_dictionary_delegate(
            cef_dictionary_value_t *self, cef_string_t *key, cef_dictionary_value_t *value);

        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
#if !DEBUG
        [SuppressUnmanagedCodeSecurity]
#endif
        private delegate int set_list_delegate(
            cef_dictionary_value_t *self, cef_string_t *key, cef_list_value_t *value);
        ...
        public static int set_dictionary(
            cef_dictionary_value_t *self, cef_string_t *key, cef_dictionary_value_t *value) {
