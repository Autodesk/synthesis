...
namespace Synthesis.CEF.Interop {
    ...
    internal unsafe struct cef_jsdialog_handler_t {
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int on_jsdialog_delegate(cef_jsdialog_handler_t *self, cef_browser_t *browser,
        ...
        [SuppressUnmanagedCodeSecurity]
#endif
        internal delegate int on_before_unload_dialog_delegate(cef_jsdialog_handler_t *self, cef_browser_t *browser,
