...
extern "C" {
	...
	*/
	 const NiFpga_Bool NiFpga_False = 0;

	/**
	* Represents a true condition.
	*/
	 const NiFpga_Bool NiFpga_True = 1;
	...
	*/
	 const NiFpga_Status NiFpga_Status_Success = 0;

	/**
	* The timeout expired before the FIFO operation could complete.
	*/
	 const NiFpga_Status NiFpga_Status_FifoTimeout = -50400;

	/**
	* A memory allocation failed. Try again after rebooting.
	*/
	 const NiFpga_Status NiFpga_Status_MemoryFull = -52000;

	/**
	* An unexpected software error occurred.
	*/
	 const NiFpga_Status NiFpga_Status_SoftwareFault = -52003;

	/**
	* A parameter to a function was not valid. This could be a NULL pointer, a bad
	* value, etc.
	*/
	 const NiFpga_Status NiFpga_Status_InvalidParameter = -52005;
	...
	*/
	 const NiFpga_Status NiFpga_Status_ResourceNotFound = -52006;
	...
	* reserved.
	*/
	 const NiFpga_Status NiFpga_Status_ResourceNotInitialized = -52010;

	/**
	* The FPGA is already running.
	*/
	 const NiFpga_Status NiFpga_Status_FpgaAlreadyRunning = -61003;

	/**
	* The bitfile was not compiled for the specified resource's device type.
	*/
	 const NiFpga_Status NiFpga_Status_DeviceTypeMismatch = -61024;

	/**
	* An error was detected in the communication between the host computer and the
	* FPGA target.
	*/
	 const NiFpga_Status NiFpga_Status_CommunicationTimeout = -61046;

	/**
	* The timeout expired before any of the IRQs were asserted.
	*/
	 const NiFpga_Status NiFpga_Status_IrqTimeout = -61060;

	/**
	* The specified bitfile is invalid or corrupt.
	*/
	 const NiFpga_Status NiFpga_Status_CorruptBitfile = -61070;
	...
	*/
	 const NiFpga_Status NiFpga_Status_BadDepth = -61072;
	...
	*/
	 const NiFpga_Status NiFpga_Status_BadReadWriteCount = -61073;
	...
	*/
	 const NiFpga_Status NiFpga_Status_ClockLostLock = -61083;
	...
	*/
	 const NiFpga_Status NiFpga_Status_FpgaBusy = -61141;
	...
	* this operation.
	*/
	 const NiFpga_Status NiFpga_Status_FpgaBusyFpgaInterfaceCApi = -61200;
	...
	* and deploy settings.
	*/
	 const NiFpga_Status NiFpga_Status_FpgaBusyScanInterface = -61201;
	...
	* operation.
	*/
	 const NiFpga_Status NiFpga_Status_FpgaBusyFpgaInterface = -61202;
	...
	* operation.
	*/
	 const NiFpga_Status NiFpga_Status_FpgaBusyInteractive = -61203;
	...
	* operation.
	*/
	 const NiFpga_Status NiFpga_Status_FpgaBusyEmulation = -61204;

	/**
	* An unexpected internal error occurred.
	*/
	 const NiFpga_Status NiFpga_Status_InternalError = -61499;
	...
	*/
	 const NiFpga_Status NiFpga_Status_AccessDenied = -63033;
	...
	*/
	 const NiFpga_Status NiFpga_Status_RpcConnectionError = -63040;
	...
	*/
	 const NiFpga_Status NiFpga_Status_RpcSessionError = -63043;
	...
	* writing.
	*/
	 const NiFpga_Status NiFpga_Status_FifoElementsCurrentlyAcquired = -63083;

	/**
	* The bitfile could not be read.
	*/
	 const NiFpga_Status NiFpga_Status_BitfileReadError = -63101;
	...
	* application.
	*/
	 const NiFpga_Status NiFpga_Status_SignatureMismatch = -63106;
	...
	* intended device.
	*/
	 const NiFpga_Status NiFpga_Status_InvalidResourceName = -63192;

	/**
	* The requested feature is not supported.
	*/
	 const NiFpga_Status NiFpga_Status_FeatureNotSupported = -63193;
	...
	*/
	 const NiFpga_Status NiFpga_Status_VersionMismatch = -63194;

	/**
	* The session is invalid or has been closed.
	*/
	 const NiFpga_Status NiFpga_Status_InvalidSession = -63195;

	/**
	* The maximum number of open FPGA sessions has been reached. Close some open
	* sessions.
	*/
	 const NiFpga_Status NiFpga_Status_OutOfHandles = -63198;
	...
	*/
	NiFpga_Inline NiFpga_Bool NiFpga_IsError(const NiFpga_Status status)
	{
	...
	*/
	 NiFpga_Inline NiFpga_Bool NiFpga_IsNotError(const NiFpga_Status status)
	{
		return status >= NiFpga_Status_Success;
	}
	...
	*/
	 NiFpga_Inline NiFpga_Status NiFpga_MergeStatus(
...
#define NiFpga_IfIsNotError(status, expression) \
	...
	*/
	 const uint32_t NiFpga_InfiniteTimeout = 0xFFFFFFFF;
