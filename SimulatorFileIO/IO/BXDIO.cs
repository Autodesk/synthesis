...
public class BXDIO
{
    ...
    private const byte REVISION_PORTION = 1;        // Bump on IO changes in a meta chunk.

    public const string ASSEMBLY_VERSION = "0.0.8.1";   // I'm so sorry that this isn't dynamic :'(
