...
public class BXDIO
{
    ...
    private const byte REVISION_PORTION = 4;        // Bump on minor additions and removals from IO.

    public const string ASSEMBLY_VERSION = "0.0.6.4";   // I'm so sorry that this isn't dynamic :'(
