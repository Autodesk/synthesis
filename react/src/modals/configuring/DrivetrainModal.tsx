...
const DrivetrainModal: React.FC<ModalPropsImpl> = ({ modalId }) => {
    ...
    const controls: { [key in DrivetrainType]: TooltipControl[] } = {
        ...
        "Tank": [{ control: "WS", description: "Drivetrain Left" }, { control: "IK", description: "Drivetrain Right" }, { control: "E", description: "Intake" }, { control: "Q", description: "Dispense" }],
        "Arcade": [{ control: "WASD", description: "Drive" }, { control: "E", description: "Intake" }, { control: "Q", description: "Dispense" }],
        "Swerve": [{ control: "WASD", description: "Drive" }, { control: "< >", description: "Turn" }, { control: "E", description: "Intake" }, { control: "Q", description: "Dispense" }]
    }
