...
public class Init : MonoBehaviour
{
    ...
    {	
		...
		Debug.Log (dynamicCamera.cameraState.GetType ().ToString ());

		switch (dynamicCamera.cameraState.GetType().ToString())
		{
		case "DynamicCamera+DriverStationState":
			Debug.Log("DriverStationState");
			dynamicCamera.SwitchCameraState(new DynamicCamera.DriverStationState(dynamicCamera));
			break;
		case "DynamicCamera+OrbitState":
			Debug.Log("OrbitState");
			dynamicCamera.SwitchCameraState(new DynamicCamera.OrbitState(dynamicCamera));
			break;
		case "DynamicCamera+FPVState":
			Debug.Log("FPVState");
			dynamicCamera.SwitchCameraState(new DynamicCamera.FPVState(dynamicCamera));
			break;
		}
