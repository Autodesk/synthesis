...
using SynthesisExporterInventor.OGLViewer;
using SynthesisExporterInventor.SkeletalStructure;
...
namespace SynthesisExporterInventor.Managers
{
    public class RobotDataManager // TODO: Refactor robot load/save methods
    {
        ...
        /// we are unable to access RobotExporterAPI or SynthesisExporterInventor, so writing the limits here is a workaround to that issue.
        /// </summary>
