...
namespace BxDRobotExporter.Wizard
{
    ...
    public partial class JointCard : UserControl
    {
        /// <summary>
...
//        public bool Merged { get => WizardData.Instance.MergeQueue.Contains(node); }
        ...
        public JointCard(RigidNode_Base node, JointForm jointForm)
        {
            ...
            jointCardEditor1.LoadSettings(node);
...
//            }
        ...
        {
            BxDRobotExporter.StandardAddInServer.Instance.SelectNode(node);
        }
        ...
        private void NodeGroupBox_Enter(object sender, EventArgs e)
        {

        }

        private void jointCardEditor1_Load(object sender, EventArgs e)
        {
        ...
        private void jointCardEditor1_Load_1(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            jointCardEditor1.Visible = !jointCardEditor1.Visible;
        }
        ...
        {
            jointCardEditor1.Visible = !collapse;
        }
    }
}