...
function updateView() {
    ...
    doument.getElementById("guideCheckbox").click(); // physically checks the box based on the saved value
    
    document.getElementById("analyticsCheckbox").checked = settings.analytics; // saves the value
    doument.getElementById("analyticsCheckbox").click(); // physically checks the box based on the saved value
}
