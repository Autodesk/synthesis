...
namespace GopherAPI.STL
{
    public class STLMesh
    {
        ...
        /// </summary>
        public Facet[] Facets { get; internal set; }
        ...
        /// </summary>
        public Color PartColor { get; internal set; }
        /// <summary>
        ...
        /// </summary>
        internal UInt32 AttributeID;

        /// <summary>
        /// Transformation matrix for the mesh
        /// </summary>
        public TransformationMatrix TransMat { get; internal set; }
