...
public partial class BXDJSkeleton
{
    ...
    private const string BXDJ_XSD_4_2 =
        ...
        <xs:element name='HasBrake' type='xs:boolean'/>
        ...
        <xs:element name='SoftwareExportedWith'>
            <xs:simpleType>
                <xs:restriction base='xs:string'>
                    <xs:enumeration value='INVENTOR'/>
                    <xs:enumeration value='FUSION_360'/>
                </xs:restriction>
            </xs:simpleType>
        </xs:element>
        ...
        <xs:element name='BXDJ'>
            <xs:complexType>
                <xs:sequence>
                    ...
                    <xs:element ref='SoftwareExportedWith' minOccurs='1' maxOccurs='1'/>
                </xs:sequence>
    ...
    private static void ReadNode_4_2(XmlReader reader, List<RigidNode_Base> nodes, ref RigidNode_Base root)
    {
        int parentID = -1;
