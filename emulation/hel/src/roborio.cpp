...
namespace hel{
    RoboRIO::RoboRIO()noexcept:engine_initialized(false),user_button(false), accelerometer(), accumulators({}), alarm(), analog_inputs(), analog_outputs(), can_motor_controllers(), counters({}), digital_system({}), ds_errors({}), match_info(), encoder_managers({}), fpga_encoders({}), global(), joysticks({}), net_comm(), power(), pwm_system(), relay_system(), robot_mode(), pcm(), pdp(), spi_system(), watchdog(){}
