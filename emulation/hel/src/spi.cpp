...
namespace nRoboRIO_FPGANamespace {
    ...
    void writeAutoTriggerConfig(hal::tSPI::tAutoTriggerConfig value, tRioStatusCode *status) {
		
	}

    void writeAutoTriggerConfig_ExternalClockSource_Channel(unsigned char value, tRioStatusCode *status) {
		
	}

    void writeAutoTriggerConfig_ExternalClockSource_Module(unsigned char value, tRioStatusCode *status) {
    ...
    hal::tSPI::tAutoTriggerConfig readAutoTriggerConfig(tRioStatusCode *status) {
		
	}

    unsigned char readAutoTriggerConfig_ExternalClockSource_Channel(tRioStatusCode *status) {
		
	}

    unsigned char readAutoTriggerConfig_ExternalClockSource_Module(tRioStatusCode *status) {
