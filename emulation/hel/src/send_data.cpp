...
namespace hel{
	SendData::SendData():serialized_data(""),new_data(true),pwm_hdrs(0.0), relays(RelaySystem::State::OFF), analog_outputs(0.0), digital_mxp({}), digital_hdrs(false), can_motor_controllers({}){}
