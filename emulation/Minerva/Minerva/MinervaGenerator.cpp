...
const array<string,minerva::MinervaGenerator::HAL_HEADER_COUNT> minerva::MinervaGenerator::HAL_HEADER_NAMES = {
	...
	"cpp/priority_condition_variable.h",
	"cpp/priority_mutex.h",
	"cpp/SerialHelper.h",
	"DIO.h",
	"DriverStation.h",
	"Encoder.h",
	"Errors.h",
	"HAL.h",
	"handles/DigitalHandleResource.h",
	"handles/HandlesInternal.h",
	"handles/IndexedClassedHandleResource.h",
	"handles/IndexedHandleResource.h",
	"handles/LimitedClassedHandleResource.h",
	"handles/LimitedHandleResource.h",
	"handles/UnlimitedHandleResource.h",
	"I2C.h",
	"Interrupts.h",
	"LabVIEW/HAL.h",
	"Notifier.h",
