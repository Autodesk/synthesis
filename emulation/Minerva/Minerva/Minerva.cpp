...
void HAL_CAN_SendMessage(uint32_t messageID, const uint8_t* data, uint8_t dataSize, int32_t periodMs, int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_CAN_SendMessage"),parameters);
}
...
void HAL_CAN_ReceiveMessage(uint32_t* messageID, uint32_t messageIDMask, uint8_t* data, uint8_t* dataSize, uint32_t* timeStamp, int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_CAN_ReceiveMessage"),parameters);
}
...
void HAL_CAN_OpenStreamSession(uint32_t* sessionHandle, uint32_t messageID, uint32_t messageIDMask, uint32_t maxMessages, int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_CAN_OpenStreamSession"),parameters);
}

void HAL_CAN_CloseStreamSession(uint32_t sessionHandle){
	std::vector<minerva::FunctionSignature::ParameterValueInfo> parameters;
	parameters.push_back({"uint32_t",sessionHandle});
	callFunc(std::string("HAL_CAN_CloseStreamSession"),parameters);
}
...
void HAL_CAN_ReadStreamSession(uint32_t sessionHandle, struct HAL_CANStreamMessage* messages, uint32_t messagesToRead, uint32_t* messagesRead, int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_CAN_ReadStreamSession"),parameters);
}
...
void HAL_CAN_GetCANStatus(float* percentBusUtilization, uint32_t* busOffCount, uint32_t* txFullCount, uint32_t* receiveErrorCount, uint32_t* transmitErrorCount, int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_CAN_GetCANStatus"),parameters);
}
...
HAL_CANHandle HAL_InitializeCAN(HAL_CANManufacturer manufacturer, int32_t deviceId, HAL_CANDeviceType deviceType, int32_t* status){
	...
	callFunc(std::string("HAL_InitializeCAN"),parameters,c);
	HAL_CANHandle x;
	c.get(x);
	return x;
}
...
void HAL_CleanCAN(HAL_CANHandle handle){
	...
	callFunc(std::string("HAL_CleanCAN"),parameters);
}
...
void HAL_WriteCANPacket(HAL_CANHandle handle, const uint8_t* data, int32_t length, int32_t apiId, int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_WriteCANPacket"),parameters);
}
...
void HAL_WriteCANPacketRepeating(HAL_CANHandle handle, const uint8_t* data, int32_t length, int32_t apiId, int32_t repeatMs, int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_WriteCANPacketRepeating"),parameters);
}
...
void HAL_StopCANPacketRepeating(HAL_CANHandle handle, int32_t apiId, int32_t* status){
	...
	parameters.push_back({"int32_t",apiId});
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_StopCANPacketRepeating"),parameters);
}
...
void HAL_ReadCANPacketNew(HAL_CANHandle handle, int32_t apiId, uint8_t* data, int32_t* length, uint64_t* receivedTimestamp, int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_ReadCANPacketNew"),parameters);
}
...
void HAL_ReadCANPacketLatest(HAL_CANHandle handle, int32_t apiId, uint8_t* data, int32_t* length, uint64_t* receivedTimestamp, int32_t* status){
	...
	parameters.push_back({"uint64_t*",receivedTimestamp});
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_ReadCANPacketLatest"),parameters);
}
...
void HAL_ReadCANPacketTimeout(HAL_CANHandle handle, int32_t apiId, uint8_t* data, int32_t* length, uint64_t* receivedTimestamp, int32_t timeoutMs, int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_ReadCANPacketTimeout"),parameters);
}
...
void HAL_ReadCANPeriodicPacket(HAL_CANHandle handle, int32_t apiId, uint8_t* data, int32_t* length, uint64_t* receivedTimestamp, int32_t timeoutMs, int32_t periodMs, int32_t* status){
	...
	parameters.push_back({"int32_t",periodMs});
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_ReadCANPeriodicPacket"),parameters);
}
...
void HAL_SetDIODirection(HAL_DigitalHandle dioPortHandle, HAL_Bool input, int32_t* status){
	...
	parameters.push_back({"HAL_Bool",input});
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_SetDIODirection"),parameters);
}
...
int HAL_GetMatchInfo(HAL_MatchInfo* info){
	...
	callFunc(std::string("HAL_GetMatchInfo"),parameters,c);
	int x;
	c.get(x);
	return x;
}
...
void HAL_FreeMatchInfo(HAL_MatchInfo* info){
	std::vector<minerva::FunctionSignature::ParameterValueInfo> parameters;
	parameters.push_back({"HAL_MatchInfo*",info});
	callFunc(std::string("HAL_FreeMatchInfo"),parameters);
}
...
int HAL_LoadOneExtension(const char* library){
	...
	minerva::Channel<int> c;
	callFunc(std::string("HAL_LoadOneExtension"),parameters,c);
	int x;
	c.get(x);
	return x;
}
...
int HAL_LoadExtensions(){
	std::vector<minerva::FunctionSignature::ParameterValueInfo> parameters;
	minerva::Channel<int> c;
	callFunc(std::string("HAL_LoadExtensions"),parameters,c);
	int x;
	c.get(x);
	return x;
}
...
void* HAL_CleanInterrupts(HAL_InterruptHandle interruptHandle, int32_t* status){
	...
	callFunc(std::string("HAL_CleanInterrupts"),parameters,c);
	void* x;
	c.get(x);
	return x;
}
...
void HAL_StopNotifier(HAL_NotifierHandle notifierHandle, int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_StopNotifier"),parameters);
}
...
void HAL_CancelNotifierAlarm(HAL_NotifierHandle notifierHandle, int32_t* status){
	...
	parameters.push_back({"HAL_NotifierHandle",notifierHandle});
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_CancelNotifierAlarm"),parameters);
}
...
uint64_t HAL_WaitForNotifierAlarm(HAL_NotifierHandle notifierHandle, int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	minerva::Channel<uint64_t> c;
	callFunc(std::string("HAL_WaitForNotifierAlarm"),parameters,c);
	uint64_t x;
	c.get(x);
	return x;
}
...
HAL_PDPHandle HAL_InitializePDP(int32_t module, int32_t* status){
	...
	callFunc(std::string("HAL_InitializePDP"),parameters,c);
	HAL_PDPHandle x;
	c.get(x);
	return x;
}
...
void HAL_CleanPDP(HAL_PDPHandle handle){
	...
	callFunc(std::string("HAL_CleanPDP"),parameters);
}
...
int32_t HAL_GetPWMLoopTiming(int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	minerva::Channel<int32_t> c;
	callFunc(std::string("HAL_GetPWMLoopTiming"),parameters,c);
	int32_t x;
	c.get(x);
	return x;
}
...
uint64_t HAL_GetPWMCycleStartTime(int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	minerva::Channel<uint64_t> c;
	callFunc(std::string("HAL_GetPWMCycleStartTime"),parameters,c);
	uint64_t x;
	c.get(x);
	return x;
}
...
void HAL_InitializeSerialPortDirect(HAL_SerialPort port, const char* portName, int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_InitializeSerialPortDirect"),parameters);
}
...
void HAL_SetOneShotDuration(HAL_SolenoidHandle solenoidPortHandle, int32_t durMS, int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_SetOneShotDuration"),parameters);
}
...
void HAL_FireOneShot(HAL_SolenoidHandle solenoidPortHandle, int32_t* status){
	...
	parameters.push_back({"HAL_SolenoidHandle",solenoidPortHandle});
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_FireOneShot"),parameters);
}
...
void HAL_InitSPIAuto(HAL_SPIPort port, int32_t bufferSize, int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_InitSPIAuto"),parameters);
}
...
void HAL_FreeSPIAuto(HAL_SPIPort port, int32_t* status){
	...
	parameters.push_back({"HAL_SPIPort",port});
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_FreeSPIAuto"),parameters);
}
...
void HAL_StartSPIAutoRate(HAL_SPIPort port, double period, int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_StartSPIAutoRate"),parameters);
}
...
void HAL_StartSPIAutoTrigger(HAL_SPIPort port, HAL_Handle digitalSourceHandle, HAL_AnalogTriggerType analogTriggerType, HAL_Bool triggerRising, HAL_Bool triggerFalling, int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_StartSPIAutoTrigger"),parameters);
}
...
void HAL_StopSPIAuto(HAL_SPIPort port, int32_t* status){
	...
	parameters.push_back({"HAL_SPIPort",port});
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_StopSPIAuto"),parameters);
}
...
void HAL_SetSPIAutoTransmitData(HAL_SPIPort port, const uint8_t* dataToSend, int32_t dataSize, int32_t zeroSize, int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_SetSPIAutoTransmitData"),parameters);
}
...
void HAL_ForceSPIAutoRead(HAL_SPIPort port, int32_t* status){
	...
	parameters.push_back({"HAL_SPIPort",port});
	parameters.push_back({"int32_t*",status});
	callFunc(std::string("HAL_ForceSPIAutoRead"),parameters);
}
...
int32_t HAL_ReadSPIAutoReceivedData(HAL_SPIPort port, uint8_t* buffer, int32_t numToRead, double timeout, int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	minerva::Channel<int32_t> c;
	callFunc(std::string("HAL_ReadSPIAutoReceivedData"),parameters,c);
	int32_t x;
	c.get(x);
	return x;
}
...
int32_t HAL_GetSPIAutoDroppedCount(HAL_SPIPort port, int32_t* status){
	...
	parameters.push_back({"int32_t*",status});
	minerva::Channel<int32_t> c;
	callFunc(std::string("HAL_GetSPIAutoDroppedCount"),parameters,c);
	int32_t x;
	c.get(x);
	return x;
}
