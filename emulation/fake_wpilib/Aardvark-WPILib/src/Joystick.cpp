...
const uint32_t Joystick::kDefaultXAxis = 1;
const uint32_t Joystick::kDefaultYAxis = 2;
const uint32_t Joystick::kDefaultZAxis = 3;
const uint32_t Joystick::kDefaultTwistAxis = 4;
const uint32_t Joystick::kDefaultThrottleAxis = 3;
const uint32_t Joystick::kDefaultTriggerButton = 1;
const uint32_t Joystick::kDefaultTopButton = 2;
