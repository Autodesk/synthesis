...
namespace SynthesisCore.UI
{
    public class EnvironmentsWindow
    {
        ...
        {
            // concrete implementation waiting on file browser, currently just using this stub code
            EnvironmentList.Add(new EnvironmentItem(EnvironmentElement, new FileInfo("Godspeed Robot Team 2374", "3d")).EnvironmentElement);
        }
